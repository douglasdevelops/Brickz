...
class ch1lvl13Scene: SKScene, SKPhysicsContactDelegate {
    ...
    let brickHealthTexture2 = SKTexture(imageNamed: "Brick3")
    let brickHealthTexture1 = SKTexture(imageNamed: "Brick4")
    ...
    var ch1lvl14Unlocked  = UserDefaults.standard.bool(forKey: "ch1lvl14Unlocked")
    ...
    override func didMove(to view: SKView) {
        ...
        brick1.texture = brickHealthTexture2
        brick1.size = brickSize
        brick1.position = CGPoint(x: self.frame.width / 2 - (self.frame.width / 5), y: self.frame.height / 3)
        brick1.name = "brick1"
        ...
        brick2.texture = brickHealthTexture2
        brick2.size = brickSize
        brick2.position = CGPoint(x: self.frame.width / 2 + (self.frame.width / 5), y: self.frame.height / 3)
        brick2.name = "brick2"
        ...
        brick3.texture = brickHealthTexture2
        brick3.size = brickSize
        brick3.position = CGPoint(x: brick1.position.x, y: brick1.position.y + (self.frame.width / 6))
        brick3.name = "brick3"
        ...
        brick4.texture = brickHealthTexture2
        brick4.size = brickSize
        brick4.position = CGPoint(x: brick3.position.x, y: brick3.position.y + (self.frame.width / 6))
        brick4.name = "brick4"
        ...
        brick5.texture = brickHealthTexture2
        brick5.size = brickSize
        brick5.position = CGPoint(x: brick4.position.x, y: brick4.position.y + (self.frame.width / 6))
        brick5.name = "brick5"
        ...
        brick6.texture = brickHealthTexture2
        brick6.size = brickSize
        brick6.position = CGPoint(x: brick5.position.x, y: brick5.position.y + (self.frame.width / 6))
        brick6.name = "brick6"
        ...
        brick7.texture = brickHealthTexture2
        brick7.size = brickSize
        brick7.position = CGPoint(x: brick6.position.x, y: brick6.position.y + (self.frame.width / 6))
        brick7.name = "brick7"
        ...
        brick8.texture = brickHealthTexture2
        brick8.size = brickSize
        brick8.position = CGPoint(x: brick2.position.x, y: brick2.position.y + (self.frame.width / 6))
        brick8.name = "brick8"
        ...
        brick9.texture = brickHealthTexture2
        brick9.size = brickSize
        brick9.position = CGPoint(x: brick8.position.x, y: (brick8.position.y + (self.frame.width / 6)))
        brick9.name = "brick9"
        ...
        brick10.texture = brickHealthTexture2
        brick10.size = brickSize
        brick10.position = CGPoint(x: brick9.position.x, y: brick9.position.y + (self.frame.width / 6))
        ...
        brick11.texture = brickHealthTexture2
        brick11.size = brickSize
        brick11.position = CGPoint(x: brick10.position.x, y: brick10.position.y + (self.frame.width / 6))
        ...
        brick12.texture = brickHealthTexture2
        brick12.size = brickSize
        brick12.position = CGPoint(x: brick11.position.x, y: brick11.position.y + (self.frame.width / 6))
    ...
    func ballHitBrick(Ball: SKSpriteNode, Brick: SKSpriteNode) {
        ...
        if Brick.name == "brick1" {
            if brick1Life == 2 {
                brick1Life -= 1
                brick1.texture = brickHealthTexture1
                ...
                if self.brickCount == 0 {
                    ...
                    gameOver = true
                    if ch1lvl14Unlocked == false {
                        ch1lvl14Unlocked = true
                        UserDefaults.standard.set(true, forKey: "ch1lvl14Unlocked")
                        UserDefaults.standard.synchronize()
                        continueBtnString = "ch1lvl14"
                        UserDefaults.standard.set("ch1lvl14", forKey: "continueBtnString")
                        UserDefaults.standard.synchronize()
                    }
        ...
        if Brick.name == "brick2" {
            if brick2Life == 2 {
                brick2Life -= 1
                brick2.texture = brickHealthTexture1
        ...
        if Brick.name == "brick3" {
            if brick3Life == 2 {
                brick3Life -= 1
                brick3.texture = brickHealthTexture1
        ...
        if Brick.name == "brick4" {
            if brick4Life == 2 {
                brick4Life -= 1
                brick4.texture = brickHealthTexture1
        ...
        if Brick.name == "brick5" {
            if brick5Life == 2 {
                brick5Life -= 1
                brick5.texture = brickHealthTexture1
        ...
        if Brick.name == "brick6" {
            if brick6Life == 2 {
                brick6Life -= 1
                brick6.texture = brickHealthTexture1
        ...
        if Brick.name == "brick7" {
            if brick7Life == 2 {
                brick7Life -= 1
                brick7.texture = brickHealthTexture1
        ...
        if Brick.name == "brick8" {
            if brick8Life == 2 {
                brick8Life -= 1
                brick8.texture = brickHealthTexture1
        ...
        if Brick.name == "brick9" {
            if brick9Life == 2 {
                brick9Life -= 1
                brick9.texture = brickHealthTexture1
        ...
        if Brick.name == "brick10" {
            if brick10Life == 2 {
                brick10Life -= 1
                brick10.texture = brickHealthTexture1
        ...
        if Brick.name == "brick11" {
            if brick11Life == 2 {
                brick11Life -= 1
                brick11.texture = brickHealthTexture1
        ...
        if Brick.name == "brick12" {
            if brick12Life == 2{
                brick12Life -= 1
                brick12.texture = brickHealthTexture1
