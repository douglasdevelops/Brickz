...
class ch1lvl39Scene: SKScene, SKPhysicsContactDelegate {
    ...
    var brickLives: Array = [4,4,4,4,4,4,6,6,5,5,5,5,4,4,4,4,4,4,6,6,5,5,5,5,4,4,4,4,4,4,6,6,5,5,5,5,4,4,4,4,4,4,6,6,5,5,5,5]
    ...
    var ch1lvl40Unlocked  = UserDefaults.standard.bool(forKey: "ch1lvl40Unlocked")
    ...
    override func didMove(to view: SKView) {
        ...
        brick1.position = CGPoint(x: self.frame.width / 2 - (brickSize.width / 2), y: self.frame.height / 3)
        brick1.name = "brick1"
        ...
        brick7.size = sbSize
        brick7.position = CGPoint(x: brick1.position.x, y: brick1.position.y + (brickSize.width * 0.75))
        brick7.name = "brick7"
        ...
        brick8.texture = sbTextureH6
        brick8.size = sbSize
        brick8.position = CGPoint(x: brick2.position.x, y: brick2.position.y + (brickSize.width * 0.75))
        brick8.name = "brick8"
        self.addChild(brick8)
        brick8.physicsBody = SKPhysicsBody(rectangleOf: sbSize)
        ...
        brick9.size = ubSize
        brick9.position = CGPoint(x: brick1.position.x - (brickSize.width * 0.75), y: brick1.position.y)
        brick9.name = "brick9"
        ...
        brick10.size = ubSize
        brick10.position = CGPoint(x: brick2.position.x + (brickSize.width * 0.75), y: brick2.position.y)
        ...
        brick11.size = ubSize
        brick11.position = CGPoint(x: brick3.position.x, y: brick3.position.y + (brickSize.width * 0.75))
        ...
        brick12.size = ubSize
        brick12.position = CGPoint(x: brick5.position.x - (brickSize.height * 1.35), y: brick5.position.y)
        ...
        brick13.position = CGPoint(x: brick5.position.x, y: brick5.position.y + brickSize.height)
        ...
        brick19.size = sbSize
        brick19.position = CGPoint(x: brick13.position.x, y: brick13.position.y + (brickSize.width * 0.75))
        ...
        brick20.size = sbSize
        brick20.position = CGPoint(x: brick14.position.x, y: brick19.position.y)
        ...
        brick21.size = ubSize
        brick21.position = CGPoint(x: brick13.position.x - (brickSize.height * 1.35), y: brick13.position.y)
        ...
        brick22.size = ubSize
        brick22.position = CGPoint(x: brick14.position.x + (brickSize.height * 1.35), y: brick14.position.y)
        ...
        brick23.size = ubSize
        brick23.position = CGPoint(x: brick15.position.x, y: brick15.position.y + (brickSize.width * 0.75))
        ...
        brick24.size = ubSize
        brick24.position = CGPoint(x: brick17.position.x - (brickSize.height * 1.35), y: brick17.position.y)
        ...
        brick25.position = CGPoint(x: brick17.position.x, y: brick17.position.y + brickSize.height)
        ...
        brick27.position = CGPoint(x: brick26.position.x + (brickSize.height * 1.35), y: brick26.position.y + (brickSize.width * 0.75))
        ...
        brick28.position = CGPoint(x: brick27.position.x - (brickSize.height * 1.35), y: brick27.position.y + (brickSize.width * 0.75))
        ...
        brick29.position = CGPoint(x: brick28.position.x - brickSize.width, y: brick28.position.y)
        ...
        brick31.size = sbSize
        brick31.position = CGPoint(x: brick25.position.x, y: brick25.position.y + (brickSize.width * 0.75))
        ...
        brick32.size = sbSize
        brick32.position = CGPoint(x: brick26.position.x, y: brick31.position.y)
        ...
        brick33.size = ubSize
        brick33.position = CGPoint(x: brick25.position.x - (brickSize.height * 1.35), y: brick25.position.y)
        ...
        brick34.size = ubSize
        brick34.position = CGPoint(x: brick26.position.x + (brickSize.height * 1.35), y: brick26.position.y)
        ...
        brick35.size = ubSize
        brick35.position = CGPoint(x: brick27.position.x, y: brick27.position.y + (brickSize.width * 0.75))
        ...
        brick36.size = ubSize
        brick36.position = CGPoint(x: brick29.position.x - (brickSize.height * 1.35), y: brick29.position.y)
        ...
        brick37.position = CGPoint(x: brick29.position.x, y: brick29.position.y + brickSize.height)
        ...
        brick42.position = CGPoint(x: brick41.position.x - (brickSize.height * 1.35), y: brick41.position.y - (brickSize.width * 0.75))
        ...
        brick43.texture = sbTextureH6
        brick43.size = sbSize
        brick43.position = CGPoint(x: brick37.position.x, y: brick37.position.y + (brickSize.width * 0.75))
        brick43.name = "brick43"
        self.addChild(brick43)
        brick43.physicsBody = SKPhysicsBody(rectangleOf: sbSize)
        ...
        brick44.texture = sbTextureH6
        brick44.size = sbSize
        brick44.position = CGPoint(x: brick38.position.x, y: brick43.position.y)
        brick44.name = "brick44"
        self.addChild(brick44)
        brick44.physicsBody = SKPhysicsBody(rectangleOf: sbSize)
        ...
        brick45.size = ubSize
        brick45.position = CGPoint(x: brick37.position.x - (brickSize.height * 1.35), y: brick37.position.y)
        ...
        brick46.texture = ubTextureH5
        brick46.size = ubSize
        brick46.position = CGPoint(x: brick38.position.x + (brickSize.height * 1.35), y: brick38.position.y)
        brick46.name = "brick46"
        self.addChild(brick46)
        brick46.physicsBody = SKPhysicsBody(rectangleOf: ubSize)
        ...
        brick47.texture = ubTextureH5
        brick47.size = ubSize
        brick47.position = CGPoint(x: brick39.position.x, y: brick39.position.y + (brickSize.width * 0.75))
        brick47.name = "brick47"
        self.addChild(brick47)
        brick47.physicsBody = SKPhysicsBody(rectangleOf: ubSize)
        ...
        brick48.texture = ubTextureH5
        brick48.size = ubSize
        brick48.position = CGPoint(x: brick41.position.x - (brickSize.height * 1.35), y: brick41.position.y)
        brick48.name = "brick48"
        self.addChild(brick48)
        brick48.physicsBody = SKPhysicsBody(rectangleOf: ubSize)
    ...
    override func touchesBegan(_ touches: Set<UITouch>, with event: UIEvent?) {
        ...
        for touch in touches {
            ...
            if gameStarted == true  && gameOver == false {
                ...
                let vector = CGVector(dx: 95 * dx, dy: 95 * dy)
    ...
    override func touchesEnded(_ touches: Set<UITouch>, with event: UIEvent?) {
        ...
        if touchedNode.name == "nextBtn" {
            ...
            brick12.run(fadeOut)
            menuBtn.run(fadeOut, completion: {
                let scene = ch1lvl40Scene(size: CGSize(width: 640, height: 1136))
                let transition = SKTransition.fade(withDuration: 0)
                scene.scaleMode = .aspectFill
                self.view?.presentScene(scene, transition: transition)
            })
    ...
    func ballHitBrick(Ball: SKSpriteNode, Brick: SKSpriteNode) {
        ...
        if Brick.name == "brick8" {
            if brickLives[7] == 6 {
                brickLives[7] -= 1
                brick8.texture = sbTextureH5
            } else if brickLives[7] == 5 {
                brickLives[7] -= 1
                brick8.texture = sbTextureH4
            } else if brickLives[7] == 4 {
                brickLives[7] -= 1
                brick8.texture = sbTextureH3
            } else if brickLives[7] == 3 {
                brickLives[7] -= 1
                brick8.texture = sbTextureH2
            } else if brickLives[7] == 2 {
                brickLives[7] -= 1
                brick8.texture = sbTextureH1
            } else if brickLives[7] == 1 {
                brickCount -= 1
                brick8.removeFromParent()
                sbExplosion.position = brick8.position
                self.addChild(sbExplosion)
                self.run(explosionWait, completion: {
                    sbExplosion.removeFromParent()
                })
        ...
        if Brick.name == "brick20" {
            if brickLives[19] == 6 {
                ...
                sbExplosion.position = brick20.position
                self.addChild(sbExplosion)
                self.run(explosionWait, completion: {
                    sbExplosion.removeFromParent()
                })
        ...
        if Brick.name == "brick43" {
            if brickLives[42] == 6 {
                brickLives[42] -= 1
                brick43.texture = sbTextureH5
            } else if brickLives[42] == 5 {
                brickLives[42] -= 1
                brick43.texture = sbTextureH4
            } else if brickLives[42] == 4 {
                brickLives[42] -= 1
                brick43.texture = sbTextureH3
            } else if brickLives[42] == 3 {
                brickLives[42] -= 1
                brick43.texture = sbTextureH2
            } else if brickLives[42] == 2 {
                brickLives[42] -= 1
                brick43.texture = sbTextureH1
            } else if brickLives[42] == 1 {
                brickCount -= 1
                brick43.removeFromParent()
                sbExplosion.position = brick43.position
                self.addChild(sbExplosion)
                self.run(explosionWait, completion: {
                    sbExplosion.removeFromParent()
                })
        ...
        if Brick.name == "brick44" {
            if brickLives[43] == 6 {
                brickLives[43] -= 1
                brick44.texture = sbTextureH5
            } else if brickLives[43] == 5 {
                brickLives[43] -= 1
                brick44.texture = sbTextureH4
            } else if brickLives[43] == 4 {
                brickLives[43] -= 1
                brick44.texture = sbTextureH3
            } else if brickLives[43] == 3 {
                brickLives[43] -= 1
                brick44.texture = sbTextureH2
            } else if brickLives[43] == 2 {
                brickLives[43] -= 1
                brick44.texture = sbTextureH1
            } else if brickLives[43] == 1 {
                brickCount -= 1
                brick44.removeFromParent()
                sbExplosion.position = brick44.position
                self.addChild(sbExplosion)
                self.run(explosionWait, completion: {
                    sbExplosion.removeFromParent()
                })
        ...
        if Brick.name == "brick46" {
            if brickLives[45] == 5 {
                brickLives[45] -= 1
                brick46.texture = ubTextureH4
            } else if brickLives[45] == 4 {
                brickLives[45] -= 1
                brick46.texture = ubTextureH3
            } else if brickLives[45] == 3 {
                brickLives[45] -= 1
                brick46.texture = ubTextureH2
            } else if brickLives[45] == 2 {
                brickLives[45] -= 1
                brick46.texture = ubTextureH1
            } else if brickLives[45] == 1 {
                brickCount -= 1
                brick46.removeFromParent()
                ubExplosion.position = brick46.position
                self.addChild(ubExplosion)
                self.run(explosionWait, completion: {
                    ubExplosion.removeFromParent()
                })
        ...
        if Brick.name == "brick47" {
            if brickLives[46] == 5 {
                brickLives[46] -= 1
                brick47.texture = ubTextureH4
            } else if brickLives[46] == 4 {
                brickLives[46] -= 1
                brick47.texture = ubTextureH3
            } else if brickLives[46] == 3 {
                brickLives[46] -= 1
                brick47.texture = ubTextureH2
            } else if brickLives[46] == 2 {
                brickLives[46] -= 1
                brick47.texture = ubTextureH1
            } else if brickLives[46] == 1 {
                brickCount -= 1
                brick47.removeFromParent()
                ubExplosion.position = brick47.position
                self.addChild(ubExplosion)
                self.run(explosionWait, completion: {
                    ubExplosion.removeFromParent()
                })
        ...
        if Brick.name == "brick48" {
            if brickLives[47] == 5 {
                brickLives[47] -= 1
                brick48.texture = ubTextureH4
            } else if brickLives[47] == 4 {
                brickLives[47] -= 1
                brick48.texture = ubTextureH3
            } else if brickLives[47] == 3 {
                brickLives[47] -= 1
                brick48.texture = ubTextureH2
            } else if brickLives[47] == 2 {
                brickLives[47] -= 1
                brick48.texture = ubTextureH1
            } else if brickLives[47] == 1 {
                brickCount -= 1
                brick48.removeFromParent()
                ubExplosion.position = brick48.position
                self.addChild(ubExplosion)
                self.run(explosionWait, completion: {
                    ubExplosion.removeFromParent()
                })
        ...
        if brickCount == 0  {
            ...
            gameOver = true
            if ch1lvl40Unlocked == false {
                ch1lvl40Unlocked = true
                UserDefaults.standard.set(true, forKey: "ch1lvl40Unlocked")
                UserDefaults.standard.synchronize()
                continueBtnString = "ch1lvl40"
                UserDefaults.standard.set("ch1lvl40", forKey: "continueBtnString")
                UserDefaults.standard.synchronize()
            }
