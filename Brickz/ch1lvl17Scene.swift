...
class ch1lvl17Scene: SKScene, SKPhysicsContactDelegate {
    ...
    var ch1lvl18Unlocked  = UserDefaults.standard.bool(forKey: "ch1lvl18Unlocked")
    ...
    override func didMove(to view: SKView) {
        ...
        brick1.position = CGPoint(x: self.frame.width / 2, y: self.frame.height / 2.5)
        brick1.name = "brick1"
        ...
        brick8.position = CGPoint(x: brick4.position.x + brickSize.width, y: brick4.position.y + brickSize.height)
        brick8.name = "brick8"
        ...
        brick9.position = CGPoint(x: brick7.position.x + brickSize.width, y: brick7.position.y + brickSize.height)
        brick9.name = "brick9"
        ...
        brick13.position = CGPoint(x: brick9.position.x + brickSize.width, y: brick9.position.y + brickSize.height)
        ...
        brick14.position = CGPoint(x: brick11.position.x - brickSize.width, y: brick12.position.y + brickSize.height)
        ...
        brick16.position = CGPoint(x: brick14.position.x - brickSize.width, y: brick14.position.y + brickSize.height)
        ...
        brick17.position = CGPoint(x: brick14.position.x + brickSize.width, y: brick16.position.y)
        ...
        brick18.position = CGPoint(x: brick15.position.x + brickSize.width, y: brick17.position.y)
        ...
        brick19.position = CGPoint(x: brick17.position.x + brickSize.width, y: brick17.position.y + brickSize.height)
        ...
        brick23.position = CGPoint(x: brick19.position.x + brickSize.width, y: brick19.position.y + brickSize.height)
        ...
        brick25.position = CGPoint(x: brick22.position.x - brickSize.width, y: brick22.position.y + brickSize.height)
        ...
        brick27.position = CGPoint(x: brick25.position.x + brickSize.width, y: brick26.position.y)
        ...
        brick28.position = CGPoint(x: brick24.position.x + brickSize.width, y: brick27.position.y)
    ...
    func ballHitBrick(Ball: SKSpriteNode, Brick: SKSpriteNode) {
        ...
        if brickCount == 0 {
            ...
            gameOver = true
            if ch1lvl18Unlocked == false {
                ch1lvl18Unlocked = true
                UserDefaults.standard.set(true, forKey: "ch1lvl18Unlocked")
                UserDefaults.standard.synchronize()
                continueBtnString = "ch1lvl18"
                UserDefaults.standard.set("ch1lvl18", forKey: "continueBtnString")
                UserDefaults.standard.synchronize()
            }
