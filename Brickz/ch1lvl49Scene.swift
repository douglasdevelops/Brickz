...
class ch1lvl49Scene: SKScene, SKPhysicsContactDelegate {
    ...
    var brickLives: Array = [10,4,3,2,1,20,19,18,17,9,16,15,8,14,13,7,12,11,6,10,5,9,4,8,7,3,6,2,5,1,4,3,2,1]
    ...
    var ch1lvl50Unlocked  = UserDefaults.standard.bool(forKey: "ch1lvl50Unlocked")
    ...
    override func didMove(to view: SKView) {
        ...
        brick2.position = CGPoint(x: brick1.position.x, y: brick1.position.y + (brickSize.height * 1.35))
        brick2.name = "brick2"
        ...
        brick4.position = CGPoint(x: brick1.position.x, y: brick1.position.y - (brickSize.height * 1.35))
        brick4.name = "brick4"
        ...
        brick6.size = ubSize
        brick6.position = CGPoint(x: brick2.position.x + (brickSize.height * 1.35), y: brick2.position.y)
        brick6.name = "brick6"
        ...
        brick7.size = ubSize
        brick7.position = CGPoint(x: brick3.position.x, y: brick3.position.y - (brickSize.height * 1.35))
        brick7.name = "brick7"
        ...
        brick8.size = ubSize
        brick8.position = CGPoint(x: brick4.position.x - (brickSize.height * 1.35), y: brick4.position.y)
        brick8.name = "brick8"
        ...
        brick9.size = ubSize
        brick9.position = CGPoint(x: brick5.position.x, y: brick5.position.y + (brickSize.height * 1.35))
        brick9.name = "brick9"
        ...
        brick10.size = sbSize
        brick10.position = CGPoint(x: brick1.position.x + (brickSize.height + brickSize.width), y: brick1.position.y)
        ...
        brick11.size = ubSize
        brick11.position = CGPoint(x: brick10.position.x + (brickSize.height * 1.35), y: brick10.position.y + (brickSize.height * 1.35))
        ...
        brick12.size = ubSize
        brick12.position = CGPoint(x: brick10.position.x + (brickSize.height  * 1.35), y: brick10.position.y - (brickSize.height * 1.35))
        ...
        brick13.size = sbSize
        brick13.position = CGPoint(x: brick1.position.x - (brickSize.height + brickSize.width), y: brick1.position.y)
        ...
        brick14.size = ubSize
        brick14.position = CGPoint(x: brick13.position.x - (brickSize.height * 1.35), y: brick13.position.y + (brickSize.height * 1.35))
        ...
        brick15.size = ubSize
        brick15.position = CGPoint(x: brick13.position.x - (brickSize.height * 1.35), y: brick13.position.y - (brickSize.height * 1.35))
        ...
        brick16.size = sbSize
        brick16.position = CGPoint(x: brick13.position.x, y: brick13.position.y - (brickSize.height + brickSize.width))
        ...
        brick17.size = ubSize
        brick17.position = CGPoint(x: brick16.position.x - (brickSize.height * 1.35), y: brick16.position.y - (brickSize.height * 1.35))
        ...
        brick18.size = ubSize
        brick18.position = CGPoint(x: brick16.position.x + (brickSize.height * 1.35), y: brick17.position.y)
        ...
        brick19.size = sbSize
        brick19.position = CGPoint(x: brick1.position.x, y: brick1.position.y - (brickSize.width + brickSize.height))
        ...
        brick20.size = ubSize
        brick20.position = CGPoint(x: brick19.position.x + (brickSize.height * 1.35), y: brick19.position.y - (brickSize.height * 1.35))
        ...
        brick21.size = sbSize
        brick21.position = CGPoint(x: brick19.position.x + (brickSize.height + brickSize.width), y: brick19.position.y)
        ...
        brick22.size = ubSize
        brick22.position = CGPoint(x: brick21.position.x + (brickSize.height * 1.35), y: brick21.position.y - (brickSize.height * 1.35))
        ...
        brick23.size = sbSize
        brick23.position = CGPoint(x: brick21.position.x, y: brick21.position.y - (brickSize.height + brickSize.width))
        ...
        brick24.size = ubSize
        brick24.position = CGPoint(x: brick23.position.x + (brickSize.height * 1.35), y: brick23.position.y - (brickSize.height * 1.35))
        ...
        brick25.size = ubSize
        brick25.position = CGPoint(x: brick23.position.x - (brickSize.height * 1.35), y: brick24.position.y)
        ...
        brick26.size = sbSize
        brick26.position = CGPoint(x: brick23.position.x - (brickSize.height + brickSize.width), y: brick23.position.y)
        ...
        brick27.size = ubSize
        brick27.position = CGPoint(x: brick26.position.x - (brickSize.height * 1.35), y: brick26.position.y - (brickSize.height * 1.35))
        ...
        brick28.size = sbSize
        brick28.position = CGPoint(x: brick26.position.x - (brickSize.height + brickSize.width), y: brick26.position.y)
        ...
        brick29.size = ubSize
        brick29.position = CGPoint(x: brick28.position.x - (brickSize.height * 1.35), y: brick28.position.y - (brickSize.height * 1.35))
        ...
        brick30.size = sbSize
        brick30.position = CGPoint(x: brick26.position.x, y: brick26.position.y - (brickSize.height + brickSize.width))
        ...
        brick31.size = ubSize
        brick31.position = CGPoint(x: brick30.position.x - (brickSize.height * 1.35), y: brick30.position.y - (brickSize.height * 1.35))
        ...
        brick32.size = ubSize
        brick32.position = CGPoint(x: brick30.position.x + (brickSize.height * 1.35), y: brick31.position.y)
        ...
        brick33.size = ubSize
        brick33.position = CGPoint(x: brick32.position.x + (brickSize.width + brickSize.height), y: brick32.position.y)
        ...
        brick34.size = ubSize
        brick34.position = CGPoint(x: brick31.position.x - (brickSize.width + brickSize.height), y: brick31.position.y)
    ...
    func ballHitBrick(Ball: SKSpriteNode, Brick: SKSpriteNode) {
        ...
        if brickCount == 0  {
            ...
            gameOver = true
            if ch1lvl50Unlocked == false {
                ch1lvl50Unlocked = true
                UserDefaults.standard.set(true, forKey: "ch1lvl50Unlocked")
                UserDefaults.standard.synchronize()
                continueBtnString = "ch1lvl50"
                UserDefaults.standard.set("ch1lvl50", forKey: "continueBtnString")
                UserDefaults.standard.synchronize()
            }
