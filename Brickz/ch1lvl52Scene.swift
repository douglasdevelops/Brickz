...
class ch1lvl52Scene: SKScene, SKPhysicsContactDelegate {
    ...
    var brickLives: Array = [4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,10,4,20,10,4,20,10,4,20,4,20,4,10,4,4,20,20,20,20,20]
    ...
    var ch1lvl53Unlocked  = UserDefaults.standard.bool(forKey: "ch1lvl53Unlocked")
    ...
    override func didMove(to view: SKView) {
        ...
        brick8.position = CGPoint(x: brick7.position.x - (self.frame.width / 35), y: brick7.position.y + (brickSize.width * 0.815))
        brick8.name = "brick8"
        ...
        brick9.position = CGPoint(x: brick8.position.x + (brickSize.height * 1.35), y: brick8.position.y + (brickSize.width * 0.815))
        brick9.name = "brick9"
        ...
        brick10.position = CGPoint(x: brick9.position.x + (brickSize.height * 1.35), y: brick9.position.y + (brickSize.width * 0.815))
        ...
        brick11.position = CGPoint(x: brick10.position.x + (brickSize.height * 1.35), y: brick10.position.y + (brickSize.width * 0.815))
        ...
        brick12.position = CGPoint(x: brick4.position.x + (self.frame.width / 35), y: brick4.position.y + (brickSize.width * 0.815))
        ...
        brick13.position = CGPoint(x: brick12.position.x - (brickSize.height * 1.35), y: brick12.position.y + (brickSize.width * 0.815))
        ...
        brick14.position = CGPoint(x: brick13.position.x - (brickSize.height * 1.35), y: brick13.position.y + (brickSize.width * 0.815))
        ...
        brick15.position = CGPoint(x: brick14.position.x - (brickSize.height * 1.35), y: brick14.position.y + (brickSize.width * 0.815))
        ...
        brick16.position = CGPoint(x: self.frame.width / 2, y: brick15.position.y + (brickSize.width * 0.815))
        ...
        brick17.size = sbSize
        brick17.position = CGPoint(x: brick8.position.x + (brickSize.height * 1.35), y: brick8.position.y)
        ...
        brick20.size = sbSize
        brick20.position = CGPoint(x: brick12.position.x - (brickSize.height * 1.35), y: brick12.position.y)
        ...
        brick23.texture = sbTextureH10
        brick23.size = sbSize
        brick23.position = CGPoint(x: brick1.position.x, y: brick1.position.y + (brickSize.height * 1.35))
        ...
        brick25.size = ubSize
        brick25.position = CGPoint(x: brick24.position.x, y: brick24.position.y + (brickSize.height * 1.35))
        ...
        brick29.size = sbSize
        brick29.position = CGPoint(x: brick26.position.x, y: brick26.position.y + (brickSize.height * 1.35))
        ...
        brick31.position = CGPoint(x: brick29.position.x - (brickSize.height * 1.35), y: brick29.position.y)
        ...
        brick32.size = ubSize
        brick32.position = CGPoint(x: brick29.position.x, y: brick29.position.y + (brickSize.height * 1.35))
        ...
        brick33.size = ubSize
        brick33.position = CGPoint(x: brick8.position.x, y: brick8.position.y + (brickSize.height * 1.35))
        ...
        brick34.size = ubSize
        brick34.position = CGPoint(x: brick10.position.x, y: brick10.position.y + (brickSize.height * 1.35))
        ...
        brick35.size = ubSize
        brick35.position = CGPoint(x: brick12.position.x, y: brick12.position.y + (brickSize.height * 1.35))
        ...
        brick36.size = ubSize
        brick36.position = CGPoint(x: brick14.position.x, y: brick14.position.y + (brickSize.height * 1.35))
    ...
    override func touchesEnded(_ touches: Set<UITouch>, with event: UIEvent?) {
        ...
        if touchedNode.name == "nextBtn" {
            ...
            brick12.run(fadeOut)
            menuBtn.run(fadeOut, completion: {
                let scene = ch1lvl53Scene(size: CGSize(width: 640, height: 1136))
                let transition = SKTransition.fade(withDuration: 0)
                scene.scaleMode = .aspectFill
                self.view?.presentScene(scene, transition: transition)
            })
    ...
    func ballHitBrick(Ball: SKSpriteNode, Brick: SKSpriteNode) {
        ...
        if Brick.name == "brick23" {
            if brickLives[22] == 10 {
                brickLives[22] -= 1
                brick23.texture = sbTextureH9
            } else if brickLives[22] == 9 {
                brickLives[22] -= 1
                brick23.texture = sbTextureH8
            } else if brickLives[22] == 8 {
                brickLives[22] -= 1
                brick23.texture = sbTextureH7
            } else if brickLives[22] == 7 {
                brickLives[22] -= 1
                brick23.texture = sbTextureH6
        ...
        if Brick.name == "brick34" {
            if brickLives[33] == 20 {
                brickLives[33] -= 1
                brick34.texture = ubTextureH19
            } else if brickLives[33] == 19 {
                brickLives[33] -= 1
                brick34.texture = ubTextureH18
            } else if brickLives[33] == 18 {
                brickLives[33] -= 1
                brick34.texture = ubTextureH17
            } else if brickLives[33] == 17 {
                brickLives[33] -= 1
                brick34.texture = ubTextureH16
            } else if brickLives[33] == 16 {
                brickLives[33] -= 1
                brick34.texture = ubTextureH15
            } else if brickLives[33] == 15 {
                brickLives[33] -= 1
                brick34.texture = ubTextureH14
            } else if brickLives[33] == 14 {
                brickLives[33] -= 1
        ...
        if Brick.name == "brick35" {
            if brickLives[34] == 20 {
                brickLives[34] -= 1
                brick35.texture = ubTextureH19
            } else if brickLives[34] == 19 {
                brickLives[34] -= 1
                brick35.texture = ubTextureH18
            } else if brickLives[34] == 18 {
                brickLives[34] -= 1
                brick35.texture = ubTextureH17
            } else if brickLives[34] == 17 {
                brickLives[34] -= 1
                brick35.texture = ubTextureH16
            } else if brickLives[34] == 16 {
                brickLives[34] -= 1
                brick35.texture = ubTextureH15
            } else if brickLives[34] == 15 {
                brickLives[34] -= 1
                brick35.texture = ubTextureH14
            } else if brickLives[34] == 14 {
                brickLives[34] -= 1
        ...
        if Brick.name == "brick36" {
            if brickLives[35] == 20 {
                brickLives[35] -= 1
                brick36.texture = ubTextureH19
            } else if brickLives[35] == 19 {
                brickLives[35] -= 1
                brick36.texture = ubTextureH18
            } else if brickLives[35] == 18 {
                brickLives[35] -= 1
                brick36.texture = ubTextureH17
            } else if brickLives[35] == 17 {
                brickLives[35] -= 1
                brick36.texture = ubTextureH16
            } else if brickLives[35] == 16 {
                brickLives[35] -= 1
                brick36.texture = ubTextureH15
            } else if brickLives[35] == 15 {
                brickLives[35] -= 1
                brick36.texture = ubTextureH14
            } else if brickLives[35] == 14 {
                brickLives[35] -= 1
        ...
        if brickCount == 0  {
            ...
            gameOver = true
            if ch1lvl53Unlocked == false {
                ch1lvl53Unlocked = true
                UserDefaults.standard.set(true, forKey: "ch1lvl53Unlocked")
                UserDefaults.standard.synchronize()
                continueBtnString = "ch1lvl53"
                UserDefaults.standard.set("ch1lvl53", forKey: "continueBtnString")
                UserDefaults.standard.synchronize()
            }
