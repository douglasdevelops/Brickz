...
class ch1lvl14Scene: SKScene, SKPhysicsContactDelegate {
    ...
    var ch1lvl15Unlocked  = UserDefaults.standard.bool(forKey: "ch1lvl15Unlocked")
    ...
    override func didMove(to view: SKView) {
        ...
        brick2.position = CGPoint(x: brick1.position.x + (self.frame.width * 0.02 + brickSize.width), y: self.frame.height / 3)
        brick2.name = "brick2"
        ...
        brick3.position = CGPoint(x: brick2.position.x + (self.frame.width * 0.02 + brickSize.width), y: self.frame.height / 3)
        brick3.name = "brick3"
        ...
        brick4.position = CGPoint(x: brick3.position.x + (self.frame.width * 0.02 + brickSize.width), y: self.frame.height / 3)
        brick4.name = "brick4"
        ...
        brick5.position = CGPoint(x: brick4.position.x + (self.frame.width * 0.02 + brickSize.width), y: self.frame.height / 3)
        brick5.name = "brick5"
        ...
        brick6.position = CGPoint(x: self.frame.width - self.frame.width / 8.8, y: self.frame.height / 2)
        brick6.name = "brick6"
        ...
        brick7.position = CGPoint(x: brick6.position.x - (self.frame.width * 0.02 + brickSize.width
        ...
        brick8.position = CGPoint(x: brick7.position.x - (self.frame.width  * 0.02 + brickSize.width), y: self.frame.height / 2)
        brick8.name = "brick8"
        ...
        brick9.position = CGPoint(x: brick8.position.x - (self.frame.width  * 0.02 + brickSize.width), y: self.frame.height / 2)
        brick9.name = "brick9"
        ...
        brick10.position = CGPoint(x: brick9.position.x - (self.frame.width * 0.02 + brickSize.width), y: self.frame.height / 2)
        ...
        brick11.position = CGPoint(x: brick1.position.x, y: self.frame.height / 1.52)
        ...
        brick12.position = CGPoint(x: brick2.position.x, y: self.frame.height / 1.52)
        ...
        brick13.position = CGPoint(x: brick3.position.x, y: self.frame.height / 1.52)
        ...
        brick14.position = CGPoint(x: brick4.position.x, y: self.frame.height / 1.52)
        ...
        brick15.position = CGPoint(x: brick5.position.x, y: self.frame.height / 1.52)
        ...
        if Brick.name == "brick1" {
            if brick1Life == 2 {
                ...
                if brickCount == 0 {
                    ...
                    gameOver = true
                    if ch1lvl15Unlocked == false {
                        ch1lvl15Unlocked = true
                        UserDefaults.standard.set(true, forKey: "ch1lvl15Unlocked")
                        UserDefaults.standard.synchronize()
                        continueBtnString = "ch1lvl15"
                        UserDefaults.standard.set("ch1lvl15", forKey: "continueBtnString")
                        UserDefaults.standard.synchronize()
                    }
