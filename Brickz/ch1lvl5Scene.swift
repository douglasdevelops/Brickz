...
//  Brickz
//
//  Created by Julian Cearley on 9/16/17.
...
class ch1lvl5Scene: SKScene, SKPhysicsContactDelegate {
    ...
    override func didMove(to view: SKView) {
        ...
        brick1.position = CGPoint(x: 0 + leftBarrier.size.width / 2 + brickSize.width * 0.71, y: self.frame.height - topBarrier.size.height * 2)
        brick1.name = "brick1"
        ...
        brick8.position = CGPoint(x: brick7.position.x - (brickSize.width * 2), y: brick7.position.y)
        brick8.name = "brick8"
        ...
        brick26.position = CGPoint(x: brick25.position.x, y: brick25.position.y + (brickSize.height * 2))
        ...
        brick27.position = CGPoint(x: brick26.position.x, y: brick26.position.y + (brickSize.height * 2))
        ...
        brick28.position = CGPoint(x: brick27.position.x, y: brick27.position.y + (brickSize.height * 2))
        ...
        if Brick.name == "brick1" {
            ...
            if brickCount == 0 {
                ...
                if ch1lvl6Unlocked == false {
                    ...
                    continueBtnString = "ch1lvl6"
                    UserDefaults.standard.set("ch1lvl6", forKey: "continueBtnString")
                    UserDefaults.standard.synchronize()
                }
