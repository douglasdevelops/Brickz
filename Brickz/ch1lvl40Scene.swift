...
class ch1lvl40Scene: SKScene, SKPhysicsContactDelegate {
    ...
    var brickLives: Array = [4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4]
    ...
    var ch1lvl41Unlocked  = UserDefaults.standard.bool(forKey: "ch1lvl41Unlocked")
    ...
    override func didMove(to view: SKView) {
        ...
        brick57.texture = brickTextureHealth4
        ...
        brick58.texture = brickTextureHealth4
        ...
        brick59.texture = brickTextureHealth4
        ...
        brick65.texture = brickTextureHealth4
    ...
    func ballHitBrick(Ball: SKSpriteNode, Brick: SKSpriteNode) {
        ...
        if Brick.name == "brick65" {
            if brickLives[64] == 4 {
                brickLives[64] -= 1
                brick65.texture = brickTextureHealth3
            } else if brickLives[64] == 3 {
                brickLives[64] -= 1
                brick65.texture = brickTextureHealth2
        ...
        if brickCount == 0  {
            ...
            gameOver = true
            if ch1lvl41Unlocked == false {
                ch1lvl41Unlocked = true
                UserDefaults.standard.set(true, forKey: "ch1lvl41Unlocked")
                UserDefaults.standard.synchronize()
                continueBtnString = "ch1lvl41"
                UserDefaults.standard.set("ch1lvl41", forKey: "continueBtnString")
                UserDefaults.standard.synchronize()
            }
