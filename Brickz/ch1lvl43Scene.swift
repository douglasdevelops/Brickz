...
class ch1lvl43Scene: SKScene, SKPhysicsContactDelegate {
    ...
    var brickLives: Array = [10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,12,12,12,12,12,12,12,12,12,12,12,12,12,12,12,12,12]
    ...
    var ch1lvl44Unlocked  = UserDefaults.standard.bool(forKey: "ch1lvl44Unlocked")
    ...
    override func didMove(to view: SKView) {
        ...
        brick1.size = sbSize
        brick1.position = CGPoint(x:  0 + self.frame.width / 8.8, y: self.frame.height - self.frame.width / 8.8)
        brick1.name = "brick1"
        ...
        brick2.size = sbSize
        brick2.position = CGPoint(x: brick1.position.x + sbSize.width, y: brick1.position.y - brickSize.width)
        brick2.name = "brick2"
        ...
        brick3.size = sbSize
        brick3.position = CGPoint(x: brick2.position.x + brickSize.width, y: brick1.position.y)
        brick3.name = "brick3"
        ...
        brick5.size = sbSize
        brick5.position = CGPoint(x: brick4.position.x + brickSize.width, y: brick1.position.y)
        brick5.name = "brick5"
        ...
        brick7.size = sbSize
        brick7.position = CGPoint(x: brick6.position.x + brickSize.width, y: brick1.position.y)
        brick7.name = "brick7"
        ...
        brick8.texture = sbTextureH10
        brick8.size = sbSize
        brick8.position = CGPoint(x: brick6.position.x + brickSize.width, y: brick6.position.y - brickSize.width)
        brick8.name = "brick8"
        ...
        brick12.size = sbSize
        brick12.position = CGPoint(x: brick11.position.x + brickSize.width, y: brick11.position.y - brickSize.width)
        ...
        brick15.size = sbSize
        brick15.position = CGPoint(x: brick14.position.x + brickSize.width, y: brick14.position.y - brickSize.width)
        ...
        brick19.size = ubSize
        brick19.position = CGPoint(x: brick2.position.x, y: brick1.position.y)
        ...
        brick20.size = ubSize
        brick20.position = CGPoint(x: brick4.position.x, y: brick3.position.y)
        ...
        brick21.size = ubSize
        brick21.position = CGPoint(x: brick6.position.x, y: brick5.position.y)
        ...
        brick22.size = ubSize
        brick22.position = CGPoint(x: brick1.position.x, y: brick2.position.y)
        ...
        brick23.size = ubSize
        brick23.position = CGPoint(x: brick3.position.x, y: brick2.position.y)
        ...
        brick24.size = ubSize
        brick24.position = CGPoint(x: brick5.position.x, y: brick4.position.y)
        ...
        brick25.size = ubSize
        brick25.position = CGPoint(x: brick7.position.x, y: brick6.position.y)
        ...
        brick26.size = ubSize
        brick26.position = CGPoint(x: brick2.position.x, y: brick8.position.y)
        ...
        brick27.size = ubSize
        brick27.position = CGPoint(x: brick4.position.x, y: brick26.position.y)
        ...
        brick28.size = ubSize
        brick28.position = CGPoint(x: brick6.position.x, y: brick27.position.y)
        ...
        brick29.size = ubSize
        brick29.position = CGPoint(x: brick8.position.x, y: brick14.position.y)
        ...
        brick30.size = ubSize
        brick30.position = CGPoint(x: brick9.position.x, y: brick29.position.y)
        ...
        brick31.size = ubSize
        brick31.position = CGPoint(x: brick10.position.x, y: brick30.position.y)
        ...
        brick32.size = ubSize
        brick32.position = CGPoint(x: brick11.position.x, y: brick31.position.y)
        ...
        brick33.size = ubSize
        brick33.position = CGPoint(x: brick12.position.x, y: brick18.position.y)
        ...
        brick34.size = ubSize
        brick34.position = CGPoint(x: brick13.position.x, y: brick33.position.y)
        ...
        brick35.size = ubSize
        brick35.position = CGPoint(x: brick14.position.x, y: brick34.position.y)
    ...
    override func touchesEnded(_ touches: Set<UITouch>, with event: UIEvent?) {
        ...
        if touchedNode.name == "retryBtn" {
            ...
            menuBtn.run(fadeOut, completion: {
                let scene = ch1lvl43Scene(size: CGSize(width: 640, height: 1136))
    ...
    func ballHitBrick(Ball: SKSpriteNode, Brick: SKSpriteNode) {
        ...
        if Brick.name == "brick8" {
            if brickLives[7] == 10 {
                brickLives[7] -= 1
                brick8.texture = sbTextureH9
            } else if brickLives[7] == 9 {
                brickLives[7] -= 1
                brick8.texture = sbTextureH8
            } else if brickLives[7] == 8 {
                brickLives[7] -= 1
                brick8.texture = sbTextureH7
        ...
        if Brick.name == "brick9" {
            if brickLives[8] == 10 {
                brickLives[8] -= 1
                brick9.texture = sbTextureH9
            } else if brickLives[8] == 9 {
                brickLives[8] -= 1
                brick9.texture = sbTextureH8
            } else if brickLives[8] == 8 {
                brickLives[8] -= 1
                brick9.texture = sbTextureH7
            } else if brickLives[8] == 7 {
                brickLives[8] -= 1
                brick9.texture = sbTextureH6
            } else if brickLives[8] == 6 {
                brickLives[8] -= 1
                brick9.texture = sbTextureH5
            } else if brickLives[8] == 5 {
                brickLives[8] -= 1
                brick9.texture = sbTextureH4
            } else if brickLives[8] == 4 {
                brickLives[8] -= 1
                brick9.texture = sbTextureH3
            } else if brickLives[8] == 3 {
                brickLives[8] -= 1
                brick9.texture = sbTextureH2
            } else if brickLives[8] == 2 {
                brickLives[8] -= 1
                brick9.texture = sbTextureH1
            } else if brickLives[8] == 1 {
                brickCount -= 1
                brick9.removeFromParent()
                sbExplosion.position = brick9.position
                self.addChild(sbExplosion)
                self.run(explosionWait, completion: {
                    sbExplosion.removeFromParent()
                })
        ...
        if brickCount == 0  {
            ...
            gameOver = true
            if ch1lvl44Unlocked == false {
                ch1lvl44Unlocked = true
                UserDefaults.standard.set(true, forKey: "ch1lvl44Unlocked")
                UserDefaults.standard.synchronize()
                continueBtnString = "ch1lvl44"
                UserDefaults.standard.set("ch1lvl44", forKey: "continueBtnString")
                UserDefaults.standard.synchronize()
            }
