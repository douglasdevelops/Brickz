...
class ch1lvl32Scene: SKScene, SKPhysicsContactDelegate {
    ...
    var brickLives: Array = [4,4,4,4,4,4,4,3,3,3,3,3,3,3,2,2,2,2,2,2,2]
    ...
    var ch1lvl33Unlocked  = UserDefaults.standard.bool(forKey: "ch1lvl33Unlocked")
    ...
    override func didMove(to view: SKView) {
        ...
        brick1.position = CGPoint(x: 0 + self.frame.width / 8.8, y: self.frame.height / 2)
        brick1.name = "brick1"
        ...
        brick9.position = CGPoint(x: brick2.position.x, y: brick2.position.y + brickSize.height)
        brick9.name = "brick9"
        ...
        brick10.position = CGPoint(x: brick3.position.x, y: brick3.position.y + brickSize.height)
        ...
        brick11.position = CGPoint(x: brick4.position.x, y: brick4.position.y + brickSize.height)
        ...
        brick12.position = CGPoint(x: brick5.position.x, y: brick5.position.y + brickSize.height)
        ...
        brick13.position = CGPoint(x: brick6.position.x, y: brick6.position.y + brickSize.height)
        ...
        brick14.position = CGPoint(x: brick7.position.x, y: brick7.position.y + brickSize.height)
        ...
        brick16.position = CGPoint(x: brick9.position.x, y: brick9.position.y + brickSize.height)
        ...
        brick17.position = CGPoint(x: brick10.position.x, y: brick10.position.y + brickSize.height)
        ...
        brick18.position = CGPoint(x: brick11.position.x, y: brick11.position.y + brickSize.height)
        ...
        brick19.position = CGPoint(x: brick12.position.x, y: brick12.position.y + brickSize.height)
        ...
        brick20.position = CGPoint(x: brick13.position.x, y: brick13.position.y + brickSize.height)
        ...
        brick21.position = CGPoint(x: brick14.position.x, y: brick14.position.y + brickSize.height)
        ...
        brick23.position = CGPoint(x: brick16.position.x, y: brick16.position.y + brickSize.height)
        ...
        brick26.position = CGPoint(x: brick19.position.x, y: brick19.position.y + brickSize.height)
        ...
        brick27.position = CGPoint(x: brick20.position.x, y: brick20.position.y + brickSize.height)
        ...
        brick28.position = CGPoint(x: brick21.position.x, y: brick21.position.y + brickSize.height)
    ...
    func ballHitBrick(Ball: SKSpriteNode, Brick: SKSpriteNode) {
        ...
        if brickCount == 0  {
            ...
            gameOver = true
            if ch1lvl33Unlocked == false {
                ch1lvl33Unlocked = true
                UserDefaults.standard.set(true, forKey: "ch1lvl33Unlocked")
                UserDefaults.standard.synchronize()
                continueBtnString = "ch1lvl33"
                UserDefaults.standard.set("ch1lvl33", forKey: "continueBtnString")
                UserDefaults.standard.synchronize()
            }
