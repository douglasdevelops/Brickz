...
class ch1lvl29Scene: SKScene, SKPhysicsContactDelegate {
    ...
    var brickLives: Array = [3,2,1,3,3,2,3,3,2,1,2,2,2,3,3,3,3,3,3,2,1,2,2,3,3,3,3,1,2,2,2,3,3,3,3,3,1,2,2,2,3,3,3,3,3,1,2,2,2,3,3,3,3,3]
    ...
    var ch1lvl30Unlocked  = UserDefaults.standard.bool(forKey: "ch1lvl30Unlocked")
    ...
    override func didMove(to view: SKView) {
        ...
        brick10.position = CGPoint(x: self.frame.width - self.frame.width / 8.8, y: brick3.position.y)
        ...
        brick12.position = CGPoint(x: brick10.position.x, y: brick10.position.y + brickSize.height)
        ...
        brick13.position = CGPoint(x: brick10.position.x, y: brick10.position.y - brickSize.height)
        ...
        brick14.position = CGPoint(x: brick11.position.x - brickSize.width, y: brick11.position.y)
        ...
        brick17.position = CGPoint(x: brick14.position.x + brickSize.width, y: brick14.position.y - brickSize.height)
        ...
        brick18.position = CGPoint(x: brick17.position.x + brickSize.width, y: brick17.position.y - brickSize.height)
        ...
        brick19.position = CGPoint(x: brick3.position.x, y: brick3.position.y - (brickSize.height * 4))
        ...
        brick23.position = CGPoint(x: brick22.position.x - brickSize.width, y: brick22.position.y - brickSize.height)
        ...
        brick25.position = CGPoint(x: brick24.position.x + brickSize.width, y: brick24.position.y + brickSize.height)
        ...
        brick28.position = CGPoint(x: self.frame.width - self.frame.width / 8.8, y: brick21.position.y)
        ...
        brick31.position = CGPoint(x: brick29.position.x + brickSize.width, y: brick29.position.y - brickSize.height)
        ...
        brick32.position = CGPoint(x: brick29.position.x - brickSize.width, y: brick29.position.y)
        ...
        brick33.position = CGPoint(x: brick32.position.x + brickSize.width, y: brick32.position.y - brickSize.height)
        ...
        brick34.position = CGPoint(x: brick33.position.x + brickSize.width, y: brick33.position.y - brickSize.height)
        ...
        brick35.position = CGPoint(x: brick32.position.x + brickSize.width, y: brick32.position.y + brickSize.height)
        ...
        brick37.position = CGPoint(x: brick28.position.x, y: brick28.position.y - (brickSize.height * 6))
        ...
        brick40.position = CGPoint(x: brick38.position.x + brickSize.width, y: brick38.position.y - brickSize.height)
        ...
        brick41.position = CGPoint(x: brick38.position.x - brickSize.width, y: brick38.position.y)
        ...
        brick42.position = CGPoint(x: brick41.position.x + brickSize.width, y: brick41.position.y + brickSize.height)
        ...
        brick44.position = CGPoint(x: brick41.position.x + brickSize.width, y: brick41.position.y - brickSize.height)
        ...
        brick45.position = CGPoint(x: brick44.position.x + brickSize.width, y: brick44.position.y - brickSize.height)
        ...
        brick46.position = CGPoint(x: brick21.position.x, y: brick38.position.y)
        ...
        brick48.position = CGPoint(x: brick47.position.x + brickSize.width, y: brick47.position.y - brickSize.height)
        ...
        brick49.position = CGPoint(x: brick48.position.x - brickSize.width, y: brick48.position.y - brickSize.height)
        ...
        brick51.position = CGPoint(x: brick50.position.x + brickSize.width, y: brick50.position.y + brickSize.height)
        ...
        brick52.position = CGPoint(x: brick51.position.x + brickSize.width, y: brick51.position.y + brickSize.height)
        ...
        brick54.position = CGPoint(x: brick53.position.x - brickSize.width, y: brick53.position.y + brickSize.height)
    ...
    func ballHitBrick(Ball: SKSpriteNode, Brick: SKSpriteNode) {
        ...
        if brickCount == 0  {
            ...
            gameOver = true
            if ch1lvl30Unlocked == false {
                ch1lvl30Unlocked = true
                UserDefaults.standard.set(true, forKey: "ch1lvl30Unlocked")
                UserDefaults.standard.synchronize()
                continueBtnString = "ch1lvl30"
                UserDefaults.standard.set("ch1lvl30", forKey: "continueBtnString")
                UserDefaults.standard.synchronize()
            }
