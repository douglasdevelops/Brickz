...
class ch1lvl53Scene: SKScene, SKPhysicsContactDelegate {
    ...
    var brickLives: Array = [20,4,20,4,20,4,20,4,20,4,20,4,20,4,20,4,10,4,4,4,4,20,20,20,20,4,20,4,20]
    ...
    var ch1lvl54Unlocked  = UserDefaults.standard.bool(forKey: "ch1lvl54Unlocked")
    ...
    override func didMove(to view: SKView) {
        ...
        brick2.position = CGPoint(x: brick1.position.x + (brickSize.height * 1.35), y: brick1.position.y - brickSize.height)
        brick2.name = "brick2"
        ...
        brick3.size = ubSize
        brick3.position = CGPoint(x: brick2.position.x + (brickSize.height * 1.35), y: brick2.position.y - brickSize.height)
        brick3.name = "brick3"
        ...
        brick4.position = CGPoint(x: brick3.position.x + (brickSize.height * 1.35), y: brick3.position.y - brickSize.height)
        brick4.name = "brick4"
        ...
        brick5.size = ubSize
        brick5.position = CGPoint(x: brick4.position.x + (brickSize.height * 1.35), y: brick4.position.y - brickSize.height)
        brick5.name = "brick5"
        ...
        brick6.position = CGPoint(x: brick5.position.x - (brickSize.height * 1.35), y: brick5.position.y - brickSize.height)
        brick6.name = "brick6"
        ...
        brick7.size = ubSize
        brick7.position = CGPoint(x: brick6.position.x - (brickSize.height * 1.35), y: brick6.position.y - brickSize.height)
        brick7.name = "brick7"
        ...
        brick8.position = CGPoint(x: brick7.position.x - (brickSize.height * 1.35), y: brick7.position.y - brickSize.height)
        brick8.name = "brick8"
        ...
        brick9.size = ubSize
        brick9.position = CGPoint(x: brick8.position.x - (brickSize.height * 1.35), y: brick8.position.y - brickSize.height)
        brick9.name = "brick9"
        ...
        brick10.position = CGPoint(x: brick1.position.x - (brickSize.height * 1.35), y: brick1.position.y - brickSize.height)
        ...
        brick11.size = ubSize
        brick11.position = CGPoint(x: brick10.position.x - (brickSize.height * 1.35), y: brick10.position.y - brickSize.height)
        ...
        brick12.position = CGPoint(x: brick11.position.x - (brickSize.height * 1.35), y: brick11.position.y - brickSize.height)
        ...
        brick13.size = ubSize
        brick13.position = CGPoint(x: brick12.position.x - (brickSize.height * 1.35), y: brick12.position.y - brickSize.height)
        ...
        brick14.position = CGPoint(x: brick13.position.x + (brickSize.height * 1.35), y: brick13.position.y - brickSize.height)
        ...
        brick15.size = ubSize
        brick15.position = CGPoint(x: brick14.position.x + (brickSize.height * 1.35), y: brick14.position.y - (brickSize.height))
        ...
        brick16.position = CGPoint(x: brick15.position.x + (brickSize.height * 1.35), y: brick15.position.y - (brickSize.height))
        ...
        brick17.size = sbSize
        brick17.position = CGPoint(x: self.frame.width / 2, y: brick5.position.y)
        ...
        brick18.position = CGPoint(x: brick17.position.x, y: brick17.position.y - (brickSize.height * 1.35))
        ...
        brick19.position = CGPoint(x: brick17.position.x, y: brick17.position.y + (brickSize.height * 1.35))
        ...
        brick20.position = CGPoint(x: brick17.position.x + (brickSize.height * 1.35), y: brick17.position.y)
        ...
        brick21.position = CGPoint(x: brick17.position.x - (brickSize.height * 1.35), y: brick17.position.y)
        ...
        brick23.size = ubSize
        brick23.position = CGPoint(x: brick21.position.x, y: brick21.position.y - (brickSize.height * 1.35))
        ...
        brick24.size = ubSize
        brick24.position = CGPoint(x: brick20.position.x, y: brick20.position.y - (brickSize.height * 1.35))
        ...
        brick25.size = ubSize
        brick25.position = CGPoint(x: brick20.position.x, y: brick20.position.y + (brickSize.height * 1.35))
        ...
        brick26.position = CGPoint(x: brick5.position.x - (brickSize.height * 1.35), y: brick5.position.y)
        ...
        brick28.position = CGPoint(x: brick13.position.x + (brickSize.height * 1.35), y: brick13.position.y)
    ...
    func ballHitBrick(Ball: SKSpriteNode, Brick: SKSpriteNode) {
        ...
        if Brick.name == "brick13" {
            if brickLives[12] == 20 {
                brickLives[12] -= 1
                brick13.texture = ubTextureH19
            } else if brickLives[12] == 19 {
                brickLives[12] -= 1
                brick13.texture = ubTextureH18
            } else if brickLives[12] == 18 {
                brickLives[12] -= 1
        ...
        if brickCount == 0  {
            ...
            gameOver = true
            if ch1lvl54Unlocked == false {
                ch1lvl54Unlocked = true
                UserDefaults.standard.set(true, forKey: "ch1lvl54Unlocked")
                UserDefaults.standard.synchronize()
                continueBtnString = "ch1lvl54"
                UserDefaults.standard.set("ch1lvl54", forKey: "continueBtnString")
                UserDefaults.standard.synchronize()
            }
