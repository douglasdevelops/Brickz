...
class ch1lvl23Scene: SKScene, SKPhysicsContactDelegate {
    ...
    var brickLives: Array = [3,3,3,3,3,3,3,3,3,3,3,3,3,3,3,3,3,3,3,3,3]
    ...
    var ch1lvl24Unlocked  = UserDefaults.standard.bool(forKey: "ch1lvl24Unlocked")
    ...
    override func didMove(to view: SKView) {
        ...
        brick4.position = CGPoint(x: brick1.position.x, y: brick1.position.y + (brickSize.height * 1.1))
        brick4.name = "brick4"
        ...
        brick5.position = CGPoint(x: brick4.position.x, y: brick4.position.y + (brickSize.height * 1.1))
        brick5.name = "brick5"
        ...
        brick6.position = CGPoint(x: brick5.position.x, y: brick5.position.y + (brickSize.height * 1.1))
        brick6.name = "brick6"
        ...
        brick7.position = CGPoint(x: brick6.position.x, y: brick6.position.y + (brickSize.height * 1.1))
        brick7.name = "brick7"
        ...
        brick8.position = CGPoint(x: brick7.position.x, y: brick7.position.y + (brickSize.height * 1.1))
        brick8.name = "brick8"
        ...
        brick9.position = CGPoint(x: brick8.position.x, y: brick8.position.y + (brickSize.height * 1.1))
        brick9.name = "brick9"
        ...
        brick10.position = CGPoint(x: brick2.position.x, y: brick2.position.y + (brickSize.height * 1.1))
        ...
        brick11.position = CGPoint(x: brick10.position.x, y: brick10.position.y + (brickSize.height * 1.1))
        ...
        brick12.position = CGPoint(x: brick11.position.x, y: brick11.position.y + (brickSize.height * 1.1))
        ...
        brick13.position = CGPoint(x: brick12.position.x, y: brick12.position.y + (brickSize.height * 1.1))
        ...
        brick14.position = CGPoint(x: brick13.position.x, y: brick13.position.y + (brickSize.height * 1.1))
        ...
        brick15.position = CGPoint(x: brick14.position.x, y: brick14.position.y + (brickSize.height * 1.1))
        ...
        brick16.position = CGPoint(x: brick3.position.x, y: brick3.position.y + (brickSize.height * 1.1))
        ...
        brick17.position = CGPoint(x: brick16.position.x, y: brick16.position.y + (brickSize.height * 1.1))
        ...
        brick18.position = CGPoint(x: brick17.position.x, y: brick17.position.y + (brickSize.height * 1.1))
        ...
        brick19.position = CGPoint(x: brick18.position.x, y: brick18.position.y + (brickSize.height * 1.1))
        ...
        brick20.position = CGPoint(x: brick19.position.x, y: brick19.position.y + (brickSize.height * 1.1))
        ...
        brick21.position = CGPoint(x: brick20.position.x, y: brick20.position.y + (brickSize.height * 1.1))
    ...
    func ballHitBrick(Ball: SKSpriteNode, Brick: SKSpriteNode) {
        ...
        if brickCount == 0  {
            ...
            gameOver = true
            if ch1lvl24Unlocked == false {
                ch1lvl24Unlocked = true
                UserDefaults.standard.set(true, forKey: "ch1lvl24Unlocked")
                UserDefaults.standard.synchronize()
                continueBtnString = "ch1lvl24"
                UserDefaults.standard.set("ch1lvl24", forKey: "continueBtnString")
                UserDefaults.standard.synchronize()
            }
