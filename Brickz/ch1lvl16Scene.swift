...
class ch1lvl16Scene: SKScene, SKPhysicsContactDelegate {
    ...
    var ch1lvl17Unlocked  = UserDefaults.standard.bool(forKey: "ch1lvl17Unlocked")
    ...
    override func didMove(to view: SKView) {
        ...
        brick9.position = CGPoint(x: brick6.position.x - brickSize.width, y: brick6.position.y + brickSize.height)
        brick9.name = "brick9"
        ...
        brick14.position = CGPoint(x: brick11.position.x - brickSize.width, y: brick11.position.y + brickSize.height)
        ...
        brick16.position = CGPoint(x: brick1.position.x, y: brick1.position.y - brickSize.height)
        ...
        brick19.position = CGPoint(x: brick16.position.x - brickSize.width, y: brick16.position.y + brickSize.height)
        ...
        brick21.position = CGPoint(x: brick16.position.x, y: brick16.position.y - (brickSize.height * 3))
        ...
        brick22.position = CGPoint(x: brick21.position.x - (brickSize.width * 2), y: brick21.position.y - brickSize.height)
        ...
        brick23.position = CGPoint(x: brick21.position.x - (brickSize.width * 2), y: brick21.position.y + brickSize.height)
        ...
        brick24.position = CGPoint(x: brick21.position.x + (brickSize.width * 2) , y: brick21.position.y + brickSize.height)
        ...
        brick25.position = CGPoint(x: brick21.position.x + (brickSize.width * 2), y: brick21.position.y - brickSize.height)
    ...
    func ballHitBrick(Ball: SKSpriteNode, Brick: SKSpriteNode) {
        ...
        if brickCount == 0 {
            ...
            gameOver = true
            if ch1lvl17Unlocked == false {
                ch1lvl17Unlocked = true
                UserDefaults.standard.set(true, forKey: "ch1lvl17Unlocked")
                UserDefaults.standard.synchronize()
                continueBtnString = "ch1lvl17"
                UserDefaults.standard.set("ch1lvl17", forKey: "continueBtnString")
                UserDefaults.standard.synchronize()
            }
