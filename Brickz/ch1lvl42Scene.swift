...
class ch1lvl42Scene: SKScene, SKPhysicsContactDelegate {
    ...
    var brickLives: Array = [10,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,10,10,10,10,10,10]
    ...
    var ch1lvl43Unlocked  = UserDefaults.standard.bool(forKey: "ch1lvl43Unlocked")
    ...
    override func didMove(to view: SKView) {
        ...
        brick1.size = sbSize
        brick1.position = CGPoint(x: self.frame.width / 2, y: self.frame.height - self.frame.width / 8.8)
        brick1.name = "brick1"
        ...
        brick2.position = CGPoint(x: 0 + self.frame.width / 8.8, y: brick1.position.y - (brickSize.width * 0.75))
        brick2.name = "brick2"
        ...
        brick8.position = CGPoint(x: brick7.position.x + brickSize.width, y: brick7.position.y)
        brick8.name = "brick8"
        ...
        brick30.size = sbSize
        brick30.position = CGPoint(x: brick1.position.x + sbSize.width, y: brick1.position.y)
        ...
        brick31.size = sbSize
        brick31.position = CGPoint(x: brick30.position.x + sbSize.width, y: brick30.position.y)
        ...
        brick32.size = sbSize
        brick32.position = CGPoint(x: brick31.position.x + sbSize.width, y: brick31.position.y)
        ...
        brick33.size = sbSize
        brick33.position = CGPoint(x: brick1.position.x - sbSize.width, y: brick1.position.y)
        ...
        brick34.size = sbSize
        brick34.position = CGPoint(x: brick33.position.x - sbSize.width, y: brick33.position.y)
        ...
        brick35.size = sbSize
        brick35.position = CGPoint(x: brick34.position.x - sbSize.width, y: brick34.position.y)
    ...
    func ballHitBrick(Ball: SKSpriteNode, Brick: SKSpriteNode) {
        ...
        if brickCount == 0  {
            ...
            gameOver = true
            if ch1lvl43Unlocked == false {
                ch1lvl43Unlocked = true
                UserDefaults.standard.set(true, forKey: "ch1lvl43Unlocked")
                UserDefaults.standard.synchronize()
                continueBtnString = "ch1lvl43"
                UserDefaults.standard.set("ch1lvl43", forKey: "continueBtnString")
                UserDefaults.standard.synchronize()
            }
