...
class ch1lvl47Scene: SKScene, SKPhysicsContactDelegate {
    ...
    var brickLives: Array = [20,4,4,4,4,4,4,4,4,4,20,4,4,20,20,4,4,4,4,4,20,10,4,4,4,20,20,10,4,4,4,20,20,10,10,10,10,10]
    ...
    var ch1lvl48Unlocked  = UserDefaults.standard.bool(forKey: "ch1lvl48Unlocked")
    ...
    override func didMove(to view: SKView) {
        ...
        brick5.position = CGPoint(x: brick1.position.x - (brickSize.height * 1.35), y: brick4.position.y)
        brick5.name = "brick5"
        ...
        brick8.position = CGPoint(x: brick1.position.x, y: brick1.position.y + brickSize.height)
        brick8.name = "brick8"
        ...
        brick12.position = CGPoint(x: brick8.position.x - brickSize.width, y: brick8.position.y)
        ...
        brick15.size = ubSize
        brick15.position = CGPoint(x: brick14.position.x, y: brick14.position.y - (ubSize.height * 2))
        ...
        brick22.texture = sbTextureH10
        brick22.size = sbSize
        brick22.position = CGPoint(x: brick18.position.x, y: brick18.position.y - (brickSize.width * 0.75))
        brick22.name = "brick22"
        self.addChild(brick22)
        brick22.physicsBody = SKPhysicsBody(rectangleOf: sbSize)
        ...
        brick24.position = CGPoint(x: brick22.position.x, y: brick22.position.y - (brickSize.height * 1.35))
        ...
        brick25.position = CGPoint(x: brick22.position.x - (brickSize.height * 1.35), y: brick22.position.y)
        ...
        brick26.size = ubSize
        brick26.position = CGPoint(x: brick25.position.x, y: brick25.position.y - (brickSize.height * 1.35))
        ...
        brick27.size = ubSize
        brick27.position = CGPoint(x: brick23.position.x, y: brick23.position.y - (brickSize.height * 1.35))
        ...
        brick28.texture = sbTextureH10
        brick28.size = sbSize
        brick28.position = CGPoint(x: brick24.position.x, y: brick24.position.y - (brickSize.height * 1.35))
        brick28.name =  "brick28"
        self.addChild(brick28)
        brick28.physicsBody = SKPhysicsBody(rectangleOf: sbSize)
        ...
        brick30.position = CGPoint(x: brick28.position.x - (brickSize.height * 1.35), y: brick28.position.y)
        ...
        brick31.position = CGPoint(x: brick28.position.x, y: brick28.position.y - (brickSize.height * 1.35))
        ...
        brick32.size = ubSize
        brick32.position = CGPoint(x: brick30.position.x, y: brick30.position.y - (brickSize.height * 1.35))
        ...
        brick33.texture = ubTextureH20
        brick33.size = ubSize
        brick33.position = CGPoint(x: brick29.position.x, y: brick29.position.y - (brickSize.height * 1.35))
        ...
        brick36.texture = sbTextureH10
        brick36.size = sbSize
        brick36.position = CGPoint(x: brick35.position.x + brickSize.width, y: brick35.position.y)
        brick36.name = "brick36"
        self.addChild(brick36)
        brick36.physicsBody = SKPhysicsBody(rectangleOf: sbSize)
        ...
        brick37.texture = sbTextureH10
        brick37.size = sbSize
        brick37.position = CGPoint(x: brick34.position.x - brickSize.width, y: brick34.position.y)
    ...
    func ballHitBrick(Ball: SKSpriteNode, Brick: SKSpriteNode) {
        ...
        if Brick.name == "brick14" {
            if brickLives[13] == 20 {
                brickLives[13] -= 1
                brick14.texture = ubTextureH19
            } else if brickLives[13] == 19 {
                brickLives[13] -= 1
                brick14.texture = ubTextureH18
            } else if brickLives[13] == 18 {
                brickLives[13] -= 1
        ...
        if Brick.name == "brick15" {
            if brickLives[14] == 20 {
                brickLives[14] -= 1
                brick15.texture = ubTextureH19
            } else if brickLives[14] == 19 {
                brickLives[14] -= 1
                brick15.texture = ubTextureH18
            } else if brickLives[14] == 18 {
                brickLives[14] -= 1
        ...
        if Brick.name == "brick22" {
            if brickLives[21] == 10 {
                brickLives[21] -= 1
                brick22.texture = sbTextureH9
            } else if brickLives[21] == 9 {
                brickLives[21] -= 1
                brick22.texture = sbTextureH8
            } else if brickLives[21] == 8 {
                brickLives[21] -= 1
                brick22.texture = sbTextureH7
            } else if brickLives[21] == 7 {
                brickLives[21] -= 1
                brick22.texture = sbTextureH6
            } else if brickLives[21] == 6 {
                brickLives[21] -= 1
                brick22.texture = sbTextureH5
            } else if brickLives[21] == 5 {
                brickLives[21] -= 1
                brick22.texture = sbTextureH4
            } else if brickLives[21] == 4 {
                brickLives[21] -= 1
                brick22.texture = sbTextureH3
            } else if brickLives[21] == 3 {
                brickLives[21] -= 1
                brick22.texture = sbTextureH2
            } else if brickLives[21] == 2 {
                brickLives[21] -= 1
                brick22.texture = sbTextureH1
            } else if brickLives[21] == 1 {
                brickCount -= 1
                brick22.removeFromParent()
                sbExplosion.position = brick22.position
        ...
        if Brick.name == "brick28" {
            if brickLives[27] == 10 {
                brickLives[27] -= 1
                brick28.texture = sbTextureH9
            } else if brickLives[27] == 9 {
                brickLives[27] -= 1
                brick28.texture = sbTextureH8
            } else if brickLives[27] == 8 {
                brickLives[27] -= 1
                brick28.texture = sbTextureH7
            } else if brickLives[27] == 7 {
                brickLives[27] -= 1
                brick28.texture = sbTextureH6
            } else if brickLives[27] == 6 {
                brickLives[27] -= 1
                brick28.texture = sbTextureH5
            } else if brickLives[27] == 5 {
                brickLives[27] -= 1
                brick28.texture = sbTextureH4
            } else if brickLives[27] == 4 {
                brickLives[27] -= 1
                brick28.texture = sbTextureH3
            } else if brickLives[27] == 3 {
                brickLives[27] -= 1
                brick28.texture = sbTextureH2
            } else if brickLives[27] == 2 {
                brickLives[27] -= 1
                brick28.texture = sbTextureH1
            } else if brickLives[27] == 1 {
                brickCount -= 1
                brick28.removeFromParent()
                sbExplosion.position = brick28.position
                self.addChild(sbExplosion)
                self.run(explosionWait, completion: {
                    sbExplosion.removeFromParent()
                })
        ...
        if Brick.name == "brick33" {
            if brickLives[32] == 20 {
                brickLives[32] -= 1
                brick33.texture = ubTextureH19
            } else if brickLives[32] == 19 {
                brickLives[32] -= 1
                brick33.texture = ubTextureH18
            } else if brickLives[32] == 18 {
                brickLives[32] -= 1
                brick33.texture = ubTextureH17
            } else if brickLives[32] == 17 {
                brickLives[32] -= 1
                brick33.texture = ubTextureH16
            } else if brickLives[32] == 16 {
                brickLives[32] -= 1
                brick33.texture = ubTextureH15
            } else if brickLives[32] == 15 {
                brickLives[32] -= 1
                brick33.texture = ubTextureH14
            } else if brickLives[32] == 14 {
                brickLives[32] -= 1
        ...
        if Brick.name == "brick36" {
            if brickLives[35] == 10 {
                brickLives[35] -= 1
                brick36.texture = sbTextureH9
            } else if brickLives[35] == 9 {
                brickLives[35] -= 1
                brick36.texture = sbTextureH8
            } else if brickLives[35] == 8 {
                brickLives[35] -= 1
                brick36.texture = sbTextureH7
            } else if brickLives[35] == 7 {
                brickLives[35] -= 1
                brick36.texture = sbTextureH6
            } else if brickLives[35] == 6 {
                brickLives[35] -= 1
                brick36.texture = sbTextureH5
            } else if brickLives[35] == 5 {
                brickLives[35] -= 1
                brick36.texture = sbTextureH4
            } else if brickLives[35] == 4 {
                brickLives[35] -= 1
                brick36.texture = sbTextureH3
            } else if brickLives[35] == 3 {
                brickLives[35] -= 1
                brick36.texture = sbTextureH2
            } else if brickLives[35] == 2 {
                brickLives[35] -= 1
                brick36.texture = sbTextureH1
            } else if brickLives[35] == 1 {
                brickCount -= 1
                brick36.removeFromParent()
                sbExplosion.position = brick36.position
                self.addChild(sbExplosion)
                self.run(explosionWait, completion: {
                    sbExplosion.removeFromParent()
                })
        ...
        if Brick.name == "brick37" {
            if brickLives[36] == 10 {
                brickLives[36] -= 1
                brick37.texture = sbTextureH9
            } else if brickLives[36] == 9 {
                brickLives[36] -= 1
                brick37.texture = sbTextureH8
            } else if brickLives[36] == 8 {
                brickLives[36] -= 1
                brick37.texture = sbTextureH7
            } else if brickLives[36] == 7 {
                brickLives[36] -= 1
                brick37.texture = sbTextureH6
            } else if brickLives[36] == 6 {
                brickLives[36] -= 1
                brick37.texture = sbTextureH5
            } else if brickLives[36] == 5 {
                brickLives[36] -= 1
                brick37.texture = sbTextureH4
            } else if brickLives[36] == 4 {
                brickLives[36] -= 1
                brick37.texture = sbTextureH3
            } else if brickLives[36] == 3 {
                brickLives[36] -= 1
                brick37.texture = sbTextureH2
        ...
        if Brick.name == "brick38" {
            if brickLives[37] == 10 {
                brickLives[37] -= 1
                brick38.texture = sbTextureH9
            } else if brickLives[37] == 9 {
                brickLives[37] -= 1
                brick38.texture = sbTextureH8
            } else if brickLives[37] == 8 {
                brickLives[37] -= 1
                brick38.texture = sbTextureH7
            } else if brickLives[37] == 7 {
                brickLives[37] -= 1
                brick38.texture = sbTextureH6
            } else if brickLives[37] == 6 {
                brickLives[37] -= 1
                brick38.texture = sbTextureH5
            } else if brickLives[37] == 5 {
                brickLives[37] -= 1
                brick38.texture = sbTextureH4
            } else if brickLives[37] == 4 {
                brickLives[37] -= 1
                brick38.texture = sbTextureH3
            } else if brickLives[37] == 3 {
                brickLives[37] -= 1
                brick38.texture = sbTextureH2
        ...
        if brickCount == 0  {
            ...
            gameOver = true
            if ch1lvl48Unlocked == false {
                ch1lvl48Unlocked = true
                UserDefaults.standard.set(true, forKey: "ch1lvl48Unlocked")
                UserDefaults.standard.synchronize()
                continueBtnString = "ch1lvl48"
                UserDefaults.standard.set("ch1lvl48", forKey: "continueBtnString")
                UserDefaults.standard.synchronize()
            }
