...
class ch1lvl26Scene: SKScene, SKPhysicsContactDelegate {
    ...
    var brickLives: Array = [3,3,3,3,3,3,3,1,1,1,1,1,1,1,3,3,3,3,3,3,3,1,1,1,1,1,1,1,3,3,3,3,3,3,3,]
    ...
    var ch1lvl27Unlocked  = UserDefaults.standard.bool(forKey: "ch1lvl27Unlocked")
    ...
    override func didMove(to view: SKView) {
        ...
        brick12.position = CGPoint(x: brick8.position.x - brickSize.width, y: brick8.position.y + brickSize.height)
        ...
        brick15.position = CGPoint(x: brick8.position.x, y: brick8.position.y + brickSize.height)
        ...
        brick19.position = CGPoint(x: brick15.position.x - brickSize.width, y: brick15.position.y + brickSize.height)
        ...
        brick20.position = CGPoint(x: brick19.position.x - brickSize.width, y: brick19.position.y + brickSize.height)
        ...
        brick22.position = CGPoint(x: brick15.position.x, y: brick15.position.y + brickSize.height)
        ...
        brick29.position = CGPoint(x: brick22.position.x, y: brick22.position.y + brickSize.height)
        ...
        brick33.position = CGPoint(x: brick29.position.x - brickSize.width, y: brick29.position.y + brickSize.height)
        ...
        brick36.position = CGPoint(x: brick29.position.x, y: brick29.position.y + brickSize.height)
        ...
        brick38.position = CGPoint(x: brick37.position.x + brickSize.width, y: brick37.position.y + brickSize.height)
        ...
        brick40.position = CGPoint(x: brick36.position.x - brickSize.width, y: brick36.position.y + brickSize.height)
        ...
        brick41.position = CGPoint(x: brick40.position.x - brickSize.width, y: brick40.position.y + brickSize.height)
    ...
    func ballHitBrick(Ball: SKSpriteNode, Brick: SKSpriteNode) {
        ...
        if brickCount == 0  {
            ...
            gameOver = true
            if ch1lvl27Unlocked == false {
                ch1lvl27Unlocked = true
                UserDefaults.standard.set(true, forKey: "ch1lvl27Unlocked")
                UserDefaults.standard.synchronize()
                continueBtnString = "ch1lvl27"
                UserDefaults.standard.set("ch1lvl27", forKey: "continueBtnString")
                UserDefaults.standard.synchronize()
            }
