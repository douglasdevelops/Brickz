...
class ch1lvl30Scene: SKScene, SKPhysicsContactDelegate {
    ...
    var brickLives: Array = [3,3,3,3,3,3,3,3,3,3,3,3,3,3,3,3,3,3,3,3,3,3,3,3,3,3,3,3,3,3,3,3,3,3,3,3,3,3,3,3,3,3,3,3,3,3,3,3,3,3,3,3,3,3,3,3,3,3,3,3,3,3,3,3,3]
    ...
    var ch1lvl31Unlocked  = UserDefaults.standard.bool(forKey: "ch1lvl31Unlocked")
    ...
    func ballHitBrick(Ball: SKSpriteNode, Brick: SKSpriteNode) {
        ...
        if brickCount == 0  {
            ...
            gameOver = true
            if ch1lvl31Unlocked == false {
                ch1lvl31Unlocked = true
                UserDefaults.standard.set(true, forKey: "ch1lvl31Unlocked")
                UserDefaults.standard.synchronize()
                continueBtnString = "ch1lvl31"
                UserDefaults.standard.set("ch1lvl31", forKey: "continueBtnString")
                UserDefaults.standard.synchronize()
            }
