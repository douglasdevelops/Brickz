...
class ch1lvl7Scene: SKScene, SKPhysicsContactDelegate {
    ...
    override func didMove(to view: SKView) {
        ...
        brick6.position = CGPoint(x: brick5.position.x - brickSize.height * 1.36, y: brick5.position.y + brickSize.height * 1.36)
        ...
        brick7.position = CGPoint(x: brick3.position.x + brickSize.height * 1.36, y: brick3.position.y + brickSize.height * 1.36)
        ...
        brick8.position = CGPoint(x: self.frame.width / 2, y: brick7.position.y)
        ...
        brick9.position = CGPoint(x: self.frame.width / 2, y: brick1.position.y + brickSize.height)
        ...
        brick12.position = CGPoint(x: brick10.position.x - brickSize.width, y: brick11.position.y)
        ...
        brick13.position = CGPoint(x: brick1.position.x + brickSize.width, y: brick1.position.y - brickSize.height)
        ...
        brick14.position = CGPoint(x: brick1.position.x - brickSize.width, y: brick13.position.y)
        ...
        brick16.position = CGPoint(x: brick13.position.x + brickSize.width, y: brick13.position.y + brickSize.height)
        ...
        brick17.position = CGPoint(x: brick13.position.x - brickSize.width, y: brick13.position.y - brickSize.height)
        ...
        brick20.position = CGPoint(x: brick17.position.x + brickSize.width, y: brick17.position.y - brickSize.height)
        ...
        brick22.position = CGPoint(x: brick20.position.x - brickSize.width, y: brick20.position.y - brickSize.height)
        ...
        brick23.position = CGPoint(x: brick8.position.x - brickSize.width * 1.5, y: brick8.position.y)
        ...
        brick24.position = CGPoint(x: brick8.position.x + brickSize.width * 1.5, y: brick8.position.y)
        ...
        brick25.position = CGPoint(x: brick5.position.x, y: brick24.position.y + (brickSize.height * 1.35))
    ...
    func ballHitBrick(Ball: SKSpriteNode, Brick: SKSpriteNode) {
        ...
        if brickCount == 0  {
            ...
            if ch1lvl8Unlocked == false {
                ...
                continueBtnString = "ch1lvl8"
                UserDefaults.standard.set("ch1lvl8", forKey: "continueBtnString")
                UserDefaults.standard.synchronize()
            }
