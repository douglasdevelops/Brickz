...
class ch1lvl11Scene: SKScene, SKPhysicsContactDelegate {
    ...
    let brickTexture1 = SKTexture(imageNamed: "Brick3")
    let brickTexture2 = SKTexture(imageNamed: "Brick4")
    ...
    var ch1lvl12Unlocked  = UserDefaults.standard.bool(forKey: "ch1lvl12Unlocked")
    ...
    override func didMove(to view: SKView) {
        ...
        brick1.texture = brickTexture1
        brick1.size = brickSize
        brick1.position = CGPoint(x: self.frame.width / 5, y: self.frame.height / 1.8)
        brick1.name = "brick1"
        ...
        brick2.texture = brickTexture1
        brick2.size = brickSize
        brick2.position = CGPoint(x: self.frame.width - (self.frame.width / 5), y: self.frame.height / 1.8)
        brick2.name = "brick2"
        ...
        brick3.texture = brickTexture2
        brick3.size = brickSize
        brick3.position = CGPoint(x: self.frame.width / 3, y: self.frame.height / 2.2)
        brick3.name = "brick3"
        ...
        brick4.texture = brickTexture2
        brick4.size = brickSize
        brick4.position = CGPoint(x: self.frame.width / 3, y: self.frame.height / 1.5)
        brick4.name = "brick4"
        ...
        brick5.texture = brickTexture2
        brick5.size = brickSize
        brick5.position = CGPoint(x: self.frame.width - (self.frame.width / 3), y: self.frame.height / 1.5)
        brick5.name = "brick5"
        ...
        brick6.texture = brickTexture2
        brick6.size = brickSize
        brick6.position = CGPoint(x: self.frame.width - (self.frame.width / 3), y: self.frame.height / 2.2)
        brick6.name = "brick6"
    ...
    func ballHitBrick(Ball: SKSpriteNode, Brick: SKSpriteNode) {
        ...
        if Brick.name == "brick1" {
            if brick1Life == 2 {
                ...
                if brickCount == 0 {
                    ...
                    gameOver = true
                    if ch1lvl12Unlocked == false {
                        ch1lvl12Unlocked = true
                        UserDefaults.standard.set(true, forKey: "ch1lvl12Unlocked")
                        UserDefaults.standard.synchronize()
                        continueBtnString = "ch1lvl12"
                        UserDefaults.standard.set("ch1lvl12", forKey: "continueBtnString")
                        UserDefaults.standard.synchronize()
                    }
        ...
        } else if Brick.name == "brick2" {
            if brick2Life == 2 {
                brick2Life -= 1
                brick2.texture = brickTexture2
                score += 10
                scoreLbl.text = "\(score)"
