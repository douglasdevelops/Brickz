...
class ch1lvl20Scene: SKScene, SKPhysicsContactDelegate {
    ...
    var brickLives: Array = [2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2]
    ...
    var ch1lvl21Unlocked  = UserDefaults.standard.bool(forKey: "ch1lvl21Unlocked")
    ...
    func ballHitBrick(Ball: SKSpriteNode, Brick: SKSpriteNode) {
        ...
        if brickCount == 0  {
            ...
            gameOver = true
            if ch1lvl21Unlocked == false {
                ch1lvl21Unlocked = true
                UserDefaults.standard.set(true, forKey: "ch1lvl21Unlocked")
                UserDefaults.standard.synchronize()
                continueBtnString = "ch1lvl21"
                UserDefaults.standard.set("ch1lvl21", forKey: "continueBtnString")
                UserDefaults.standard.synchronize()
            }
