...
//  Brickz
//
//  Created by Julian Cearley on 9/15/17.
...
class ch1lvl3Scene: SKScene, SKPhysicsContactDelegate {
    ...
    override func didMove(to view: SKView) {
        ...
        brick2.position = CGPoint(x: brick1.position.x + brickSize.width + self.frame.width / 20, y: self.frame.height / 1.3)
        brick2.name = "brick2"
        ...
        brick3.position = CGPoint(x: brick2.position.x + brickSize.width + self.frame.width / 20, y: self.frame.height / 1.3)
        brick3.name = "brick3"
        ...
        brick4.position = CGPoint(x: brick1.position.x - brickSize.width - self.frame.width / 20, y: self.frame.height / 1.3)
        brick4.name = "brick4"
        ...
        brick5.position = CGPoint(x: brick4.position.x - brickSize.width - self.frame.width / 20, y: self.frame.height / 1.3)
        brick5.name = "brick5"
        ...
        brick6.position = CGPoint(x: brick1.position.x + brickSize.width / 2, y: self.frame.height / 1.43)
        brick6.name = "brick6"
        ...
        brick7.position = CGPoint(x: brick6.position.x + brickSize.width * 1.3, y: self.frame.height / 1.43)
        brick7.name = "brick7"
        ...
        brick8.position = CGPoint(x: brick6.position.x - brickSize.width * 1.3, y: self.frame.height / 1.43)
        brick8.name = "brick8"
        ...
        brick9.position = CGPoint(x: brick8.position.x - brickSize.width * 1.3, y: self.frame.height / 1.43)
        brick9.name = "brick9"
    ...
    func didBegin(_ contact: SKPhysicsContact) {
        if(contact.bodyA.node != nil && contact.bodyB.node != nil) {
            ...
            if (firstBody.name == "ball") && (secondBody.name == "bottomBarrier") {
                ...
                ballHitBottomBarrier(Ball: secondBody, Barrier: bottomBarrier)
            }
        ...
        if Brick.name == "brick1" {
            ...
            if brickCount == 0 {
                ...
                if ch1lvl4Unlocked == false {
                    ...
                    continueBtnString = "ch1lvl4"
                    UserDefaults.standard.set("ch1lvl4", forKey: "continueBtnString")
                    UserDefaults.standard.synchronize()
                }
