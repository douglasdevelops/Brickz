...
class ch1lvl8Scene: SKScene, SKPhysicsContactDelegate {
    ...
    override func didMove(to view: SKView) {
        ...
        brick7.position = CGPoint(x: brick1.position.x, y: brick1.position.y + (brickSize.height * 2))
        ...
        brick13.position = CGPoint(x: brick1.position.x, y: brick1.position.y + (brickSize.height * 4))
        ...
        brick19.position = CGPoint(x: brick7.position.x , y: brick13.position.y + (brickSize.height * 2))
        ...
        brick25.position = CGPoint(x: brick19.position.x, y: brick19.position.y + (brickSize.height * 2))
        ...
        brick32.position = CGPoint(x: brick31.position.x, y: brick31.position.y - (brickSize.height * 2))
        ...
        brick33.position = CGPoint(x: brick32.position.x, y: brick32.position.y - (brickSize.height * 2))
        ...
        brick34.position = CGPoint(x: brick33.position.x, y: brick33.position.y - (brickSize.height * 2))
        ...
        brick35.position = CGPoint(x: brick34.position.x, y: brick34.position.y - (brickSize.height * 2))
    ...
    func ballHitBrick(Ball: SKSpriteNode, Brick: SKSpriteNode) {
        ...
        if brickCount == 0  {
            ...
            if ch1lvl9Unlocked == false {
                ...
                continueBtnString = "ch1lvl9"
                UserDefaults.standard.set("ch1lvl9", forKey: "continueBtnString")
                UserDefaults.standard.synchronize()
            }
