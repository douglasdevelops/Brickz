...
class ch1lvl4Scene: SKScene, SKPhysicsContactDelegate {
    ...
    override func didMove(to view: SKView) {
        ...
        brick1.position = CGPoint(x: 0 + brickSize.width / 2 + leftBarrier.size.width, y: topBarrier.position.y - brickSize.height)
        brick1.name = "brick1"
        ...
        brick2.position = CGPoint(x: self.frame.width - brickSize.width / 2 - leftBarrier.size.width, y: topBarrier.position.y - brickSize.height)
        brick2.name = "brick2"
        ...
        brick3.position = CGPoint(x: brick1.position.x + brickSize.width, y: brick1.position.y - brickSize.height)
        brick3.name = "brick3"
        ...
        brick4.position = CGPoint(x: brick2.position.x - brickSize.width, y: brick3.position.y)
        brick4.name = "brick4"
        ...
        brick5.position = CGPoint(x: brick3.position.x + brickSize.width, y: brick3.position.y - brickSize.height)
        brick5.name = "brick5"
        ...
        brick6.position = CGPoint(x: brick4.position.x - brickSize.width, y: brick5.position.y)
        brick6.name = "brick6"
        ...
        brick9.position = CGPoint(x: brick5.position.x - brickSize.width, y: brick5.position.y - brickSize.height)
        brick9.name = "brick9"
        ...
        brick14.position = CGPoint(x: brick12.position.x, y: brick12.position.y + brickSize.height)
        ...
        brick15.position = CGPoint(x: brick6.position.x + brickSize.width, y: brick6.position.y)
        ...
        brick18.position = CGPoint(x: brick16.position.x, y: brick16.position.y - brickSize.height)
        ...
        if Brick.name == "brick1" {
            ...
            if brickCount == 0 {
                ...
                if ch1lvl5Unlocked == false {
                    ...
                    continueBtnString = "ch1lvl5"
                    UserDefaults.standard.set("ch1lvl5", forKey: "continueBtnString")
                    UserDefaults.standard.synchronize()
                }
