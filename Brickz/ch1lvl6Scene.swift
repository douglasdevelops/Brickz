...
//  Brickz
//
//  Created by Julian Cearley on 9/17/17.
...
class ch1lvl6Scene: SKScene, SKPhysicsContactDelegate {
    ...
    override func didMove(to view: SKView) {
        ...
        brick12.position = CGPoint(x: brick10.position.x + brickSize.width, y: brick10.position.y)
        ...
        brick13.position = CGPoint(x: brick3.position.x, y: brick3.position.y - brickSize.height)
        ...
        brick14.position = CGPoint(x: brick5.position.x, y: brick5.position.y - brickSize.height)
        ...
        brick15.position = CGPoint(x: brick7.position.x, y: brick7.position.y - brickSize.height)
        ...
        brick24.position = CGPoint(x: brick22.position.x, y: brick22.position.y + brickSize.height)
        ...
        brick25.position = CGPoint(x: brick21.position.x + brickSize.width, y: brick21.position.y)
        ...
        brick26.position = CGPoint(x: brick23.position.x - brickSize.width, y: brick23.position.y)
        ...
        brick27.position = CGPoint(x: brick22.position.x , y: brick22.position.y - brickSize.height)
        ...
        brick29.position = CGPoint(x: brick27.position.x - brickSize.width, y: brick27.position.y)
        ...
        brick30.position = CGPoint(x: brick27.position.x + brickSize.width, y: brick27.position.y)
        ...
        if Brick.name == "brick1" {
            ...
            if brickCount == 0 {
                ...
                if ch1lvl7Unlocked == false {
                    ...
                    continueBtnString = "ch1lvl7"
                    UserDefaults.standard.set("ch1lvl7", forKey: "continueBtnString")
                    UserDefaults.standard.synchronize()
                }
