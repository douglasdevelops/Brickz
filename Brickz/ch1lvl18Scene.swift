...
class ch1lvl18Scene: SKScene, SKPhysicsContactDelegate {
    ...
    var ch1lvl19Unlocked  = UserDefaults.standard.bool(forKey: "ch1lvl19Unlocked")
    ...
    override func didMove(to view: SKView) {
        ...
        brick1.position = CGPoint(x: self.frame.width / 6.8 + brickSize.width, y: self.frame.height / 3 + brickSize.height)
        brick1.name = "brick1"
        ...
        brick9.position = CGPoint(x: brick5.position.x, y: brick5.position.y + brickSize.height)
        brick9.name = "brick9"
        ...
        brick13.position = CGPoint(x: brick9.position.x, y: brick9.position.y + brickSize.height)
        ...
        brick17.position = CGPoint(x: brick13.position.x, y: brick13.position.y + brickSize.height)
        ...
        brick21.position = CGPoint(x: brick17.position.x, y: brick17.position.y + brickSize.height)
        ...
        brick25.position = CGPoint(x: brick21.position.x, y: brick21.position.y + brickSize.height)
        ...
        brick29.position = CGPoint(x: brick25.position.x, y: brick25.position.y + brickSize.height)
        ...
        brick33.position = CGPoint(x: brick29.position.x, y: brick29.position.y + brickSize.height)
        ...
        brick37.position = CGPoint(x: brick33.position.x, y: brick33.position.y + brickSize.height)
    ...
    func ballHitBrick(Ball: SKSpriteNode, Brick: SKSpriteNode) {
        ...
        if Brick.name == "brick40" {
         ...
         if brickCount == 0 {
            ...
            gameOver = true
            if ch1lvl19Unlocked == false {
                ch1lvl19Unlocked = true
                UserDefaults.standard.set(true, forKey: "ch1lvl19Unlocked")
                UserDefaults.standard.synchronize()
                continueBtnString = "ch1lvl19"
                UserDefaults.standard.set("ch1lvl19", forKey: "continueBtnString")
                UserDefaults.standard.synchronize()
            }
