...
class ch1lvl41Scene: SKScene, SKPhysicsContactDelegate {
    ...
    var brickLives: Array = [7,4,4,4,4,8,8,8,8,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10]
    ...
    var ch1lvl42Unlocked  = UserDefaults.standard.bool(forKey: "ch1lvl42Unlocked")
    ...
    override func didMove(to view: SKView) {
        ...
        brick2.position = CGPoint(x: brick1.position.x, y: brick1.position.y - (brickSize.width * 0.75))
        brick2.name = "brick2"
        ...
        brick4.position = CGPoint(x: brick1.position.x, y: brick1.position.y + (brickSize.width * 0.75))
        brick4.name = "brick4"
        ...
        brick7.size = ubSize
        brick7.position = CGPoint(x: brick3.position.x, y: brick3.position.y - (brickSize.width * 0.75))
        brick7.name = "brick7"
        ...
        brick9.size = ubSize
        brick9.position = CGPoint(x: brick5.position.x, y: brick5.position.y + (brickSize.width * 0.75))
        brick9.name = "brick9"
        ...
        brick10.size = ubSize
        brick10.position = CGPoint(x: self.frame.width / 2, y: self.frame.height / 1.4)
        ...
        brick11.size = ubSize
        brick11.position = CGPoint(x: brick10.position.x + (ubSize.width * 2), y: brick10.position.y)
        ...
        brick12.size = ubSize
        brick12.position = CGPoint(x: brick11.position.x + (ubSize.width * 2), y: brick11.position.y)
        ...
        brick13.size = ubSize
        brick13.position = CGPoint(x: brick10.position.x - (ubSize.width * 2), y: brick10.position.y)
        ...
        brick14.size = ubSize
        brick14.position = CGPoint(x: brick13.position.x - (ubSize.width * 2), y: brick13.position.y)
        ...
        brick16.size = ubSize
        brick16.position = CGPoint(x: brick15.position.x + (ubSize.width * 2), y: brick15.position.y)
        ...
        brick17.size = ubSize
        brick17.position = CGPoint(x: brick16.position.x + (ubSize.width * 2), y: brick16.position.y)
        ...
        brick18.size = ubSize
        brick18.position = CGPoint(x: brick17.position.x + (ubSize.width * 2), y: brick17.position.y)
        ...
        brick19.size = ubSize
        brick19.position = CGPoint(x: brick18.position.x + (ubSize.width * 2), y: brick18.position.y)
        ...
        brick20.size = ubSize
        brick20.position = CGPoint(x: brick19.position.x + (ubSize.width * 2), y: brick19.position.y)
        ...
        brick23.size = ubSize
        brick23.position = CGPoint(x: brick22.position.x - (ubSize.width * 2), y: brick22.position.y)
        ...
        brick25.size = ubSize
        brick25.position = CGPoint(x: brick24.position.x - (ubSize.width * 2), y: brick24.position.y)
        ...
        brick26.size = ubSize
        brick26.position = CGPoint(x: brick25.position.x - ubSize.width, y: brick25.position.y - ubSize.height)
        ...
        brick30.size = ubSize
        brick30.position = CGPoint(x: brick29.position.x + (ubSize.width * 2), y: brick29.position.y)
        ...
        brick31.size = ubSize
        brick31.position = CGPoint(x: brick30.position.x + (ubSize.width * 2), y: brick30.position.y)
        ...
        brick32.size = ubSize
        brick32.position = CGPoint(x: brick31.position.x - ubSize.width, y: brick31.position.y - ubSize.height)
        ...
        brick33.size = ubSize
        brick33.position = CGPoint(x: brick32.position.x - (ubSize.width * 2), y: brick32.position.y)
        ...
        brick34.size = ubSize
        brick34.position = CGPoint(x: brick33.position.x - (ubSize.width * 2), y: brick33.position.y)
        ...
        brick36.size = ubSize
        brick36.position = CGPoint(x: brick35.position.x - (ubSize.width * 2), y: brick35.position.y)
    ...
    override func touchesEnded(_ touches: Set<UITouch>, with event: UIEvent?) {
        ...
        if touchedNode.name == "retryBtn" {
            ...
            menuBtn.run(fadeOut, completion: {
                let scene = ch1lvl41Scene(size: CGSize(width: 640, height: 1136))
        ...
        if touchedNode.name == "nextBtn" {
            ...
            brick12.run(fadeOut)
            menuBtn.run(fadeOut, completion: {
                let scene = ch1lvl42Scene(size: CGSize(width: 640, height: 1136))
                let transition = SKTransition.fade(withDuration: 0)
                scene.scaleMode = .aspectFill
                self.view?.presentScene(scene, transition: transition)
            })
    ...
    func ballHitBrick(Ball: SKSpriteNode, Brick: SKSpriteNode) {
        ...
        if brickCount == 0  {
            ...
            gameOver = true
            if ch1lvl42Unlocked == false {
                ch1lvl42Unlocked = true
                UserDefaults.standard.set(true, forKey: "ch1lvl42Unlocked")
                UserDefaults.standard.synchronize()
                continueBtnString = "ch1lvl42"
                UserDefaults.standard.set("ch1lvl42", forKey: "continueBtnString")
                UserDefaults.standard.synchronize()
            }
