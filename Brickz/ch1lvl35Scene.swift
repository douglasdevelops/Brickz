...
class ch1lvl35Scene: SKScene, SKPhysicsContactDelegate {
    ...
    var ch1lvl36Unlocked  = UserDefaults.standard.bool(forKey: "ch1lvl36Unlocked")
    ...
    override func didMove(to view: SKView) {
        ...
        brick1.position = CGPoint(x: 0 + self.frame.width / 8.8, y: self.frame.height / 1.1)
        brick1.name = "brick1"
        ...
        brick3.position = CGPoint(x: brick2.position.x + (brickSize.width * 2), y: brick2.position.y)
        brick3.name = "brick3"
        ...
        brick4.position = CGPoint(x: brick3.position.x + (brickSize.width * 2), y: brick3.position.y)
        brick4.name = "brick4"
        ...
        brick6.position = CGPoint(x: brick5.position.x + (brickSize.width * 2), y: brick5.position.y)
        brick6.name = "brick6"
        ...
        brick7.position = CGPoint(x: brick6.position.x + (brickSize.width * 2), y: brick6.position.y)
        brick7.name = "brick7"
        ...
        brick8.position = CGPoint(x: brick7.position.x + brickSize.width, y: brick7.position.y - brickSize.height)
        brick8.name = "brick8"
        ...
        brick9.position = CGPoint(x: brick8.position.x - (brickSize.width * 2), y: brick8.position.y)
        brick9.name = "brick9"
        ...
        brick11.position = CGPoint(x: brick10.position.x - (brickSize.width * 2), y: brick10.position.y)
        ...
        brick14.position = CGPoint(x: brick13.position.x + (brickSize.width * 2), y: brick13.position.y)
        ...
        brick15.position = CGPoint(x: brick14.position.x + brickSize.width, y: brick14.position.y - brickSize.height)
        ...
        brick16.position = CGPoint(x: brick15.position.x - (brickSize.width * 2), y: brick15.position.y)
        ...
        brick21.position = CGPoint(x: brick20.position.x + (brickSize.width * 2), y: brick20.position.y)
        ...
        brick22.position = CGPoint(x: brick21.position.x + brickSize.width, y: brick21.position.y - brickSize.height)
        ...
        brick24.position = CGPoint(x: brick23.position.x - (brickSize.width * 2), y: brick23.position.y)
        ...
        brick25.position = CGPoint(x: brick24.position.x - (brickSize.width * 2),y: brick24.position.y)
        ...
        brick26.position = CGPoint(x: brick25.position.x + brickSize.width, y: brick25.position.y - brickSize.height)
        ...
        brick27.position = CGPoint(x: brick26.position.x + (brickSize.width * 2), y: brick26.position.y)
        ...
        brick28.position = CGPoint(x: brick27.position.x + (brickSize.width * 2), y: brick27.position.y)
        ...
        brick29.position = CGPoint(x: brick1.position.x + brickSize.width, y: brick1.position.y)
        ...
        brick30.position = CGPoint(x: brick29.position.x + (brickSize.width * 2), y: brick29.position.y)
        ...
        brick31.position = CGPoint(x: brick30.position.x + (brickSize.width * 2), y: brick30.position.y)
        ...
        brick33.position = CGPoint(x: brick32.position.x - (brickSize.width * 2), y: brick32.position.y)
        ...
        brick34.position = CGPoint(x: brick33.position.x - (brickSize.width * 2), y: brick33.position.y)
        ...
        brick35.position = CGPoint(x: brick34.position.x - (brickSize.width * 2), y: brick34.position.y)
        ...
        brick36.position = CGPoint(x: brick35.position.x + brickSize.width, y: brick35.position.y - brickSize.height)
        ...
        brick37.position = CGPoint(x: brick36.position.x + (brickSize.width * 2), y: brick36.position.y)
        ...
        brick38.position = CGPoint(x: brick37.position.x + (brickSize.width * 2), y: brick37.position.y)
        ...
        brick39.position = CGPoint(x: brick38.position.x + brickSize.width, y: brick38.position.y - brickSize.height)
        ...
        brick40.position = CGPoint(x: brick39.position.x - (brickSize.width * 2), y: brick39.position.y)
        ...
        brick41.position = CGPoint(x: brick40.position.x - (brickSize.width * 2), y: brick40.position.y)
        ...
        brick42.position = CGPoint(x: brick41.position.x - (brickSize.width * 2), y: brick41.position.y)
        ...
        brick43.position = CGPoint(x: brick42.position.x + brickSize.width, y: brick42.position.y - brickSize.height)
        ...
        brick44.position = CGPoint(x: brick43.position.x + (brickSize.width * 2), y: brick43.position.y)
        ...
        brick45.position = CGPoint(x: brick44.position.x + (brickSize.width * 2), y: brick44.position.y)
        ...
        brick46.position = CGPoint(x: brick45.position.x + brickSize.width, y: brick45.position.y - brickSize.height)
        ...
        brick47.position = CGPoint(x: brick46.position.x - (brickSize.width * 2), y: brick46.position.y)
        ...
        brick48.position = CGPoint(x: brick47.position.x - (brickSize.width * 2), y: brick47.position.y)
        ...
        brick49.position = CGPoint(x: brick48.position.x - (brickSize.width * 2), y: brick48.position.y)
        ...
        brick50.position = CGPoint(x: brick49.position.x + brickSize.width, y: brick49.position.y - brickSize.height)
        ...
        brick51.position = CGPoint(x: brick50.position.x + (brickSize.width * 2), y: brick50.position.y)
        ...
        brick52.position = CGPoint(x: brick51.position.x + (brickSize.width * 2), y: brick51.position.y)
        ...
        brick53.position = CGPoint(x: brick52.position.x + brickSize.width, y: brick52.position.y - brickSize.height)
        ...
        brick54.position = CGPoint(x: brick53.position.x - (brickSize.width * 2), y: brick53.position.y)
        ...
        brick55.position = CGPoint(x: brick54.position.x - (brickSize.width * 2), y: brick54.position.y)
        ...
        brick56.position = CGPoint(x: brick55.position.x - (brickSize.width * 2), y: brick55.position.y)
    ...
    override func touchesEnded(_ touches: Set<UITouch>, with event: UIEvent?) {
        ...
        if touchedNode.name == "retryBtn" {
            ...
            menuBtn.run(fadeOut, completion: {
                let scene = ch1lvl35Scene(size: CGSize(width: 640, height: 1136))
    ...
    func ballHitBrick(Ball: SKSpriteNode, Brick: SKSpriteNode) {
        ...
        if brickCount == 0  {
            ...
            gameOver = true
            if ch1lvl36Unlocked == false {
                ch1lvl36Unlocked = true
                UserDefaults.standard.set(true, forKey: "ch1lvl36Unlocked")
                UserDefaults.standard.synchronize()
                continueBtnString = "ch1lvl36"
                UserDefaults.standard.set("ch1lvl36", forKey: "continueBtnString")
                UserDefaults.standard.synchronize()
            }
